...
/// <summary>Identifies the compile-time construction route available for one concrete Mutagen model.</summary>
internal enum RecordTypeConstructionKind
{
...
/// <summary>Describes the statically callable construction surface of one concrete Mutagen model.</summary>
internal sealed class RecordTypeConstructionModel
{
    /// <summary>Initializes one concrete Mutagen type construction description.</summary>
    ...
    internal RecordTypeConstructionModel(
        RecordTypeConstructionKind kind,
    ...
    internal RecordTypeConstructionKind Kind { get; }
...
/// <summary>Identifies the recursive wire and Mutagen construction shape of one value.</summary>
internal enum RecordValueConstructionKind
{
    ...
    /// <summary>A concrete nested indexed Mutagen model.</summary>
    NestedConcrete,

    /// <summary>An abstract record union selected by an exact generated discriminator.</summary>
    NestedPolymorphic
}

/// <summary>Describes one recursively classified mutable/getter value pair for generated construction.</summary>
internal sealed class RecordValueConstructionModel
{
    /// <summary>Initializes one complete recursive construction description.</summary>
    /// <param name="kind">The closed Mutagen construction category.</param>
    ...
    internal RecordValueConstructionModel(
        RecordValueConstructionKind kind,
        Type mutableType,
        Type getterType,
        NullabilityInfo nullability,
        RecordValueConstructionModel? element = null)
    {
    ...
    /// <summary>Gets the closed Mutagen construction category.</summary>
    internal RecordValueConstructionKind Kind { get; }

    /// <summary>Gets the mutable Mutagen API type.</summary>
    ...
    internal RecordValueConstructionModel? Element { get; }
}
