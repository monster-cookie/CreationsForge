...
public sealed partial class SkyrimRecordEditService
{
    ...
    private readonly SkyrimFormListInspector _inspector;

    /// <summary>Initializes a Skyrim record edit service with the adapter's complete FormList inspector.</summary>
    ...
    public SkyrimRecordEditService(SkyrimFormListInspector inspector)
    {
    ...
    public PreparedFormListEdit PrepareEdit(FormListEdit edit)
    {
        ...
        switch (edit)
        {
            case SetEditorIdEdit setEditorId:
            {
                ...
                var fingerprint = RecordEditFingerprintFactory.Create(
                    edit.CommandName,
                    (writer, context) =>
                    {
                        writer.WriteStartObject();
                        writer.WritePropertyName("editorId");
                        RecordJsonLeafWriter.WriteString(writer, editorId, context);
            ...
            case InsertItemEdit insertItem:
            {
                var fingerprint = RecordEditFingerprintFactory.Create(
                    ...
                    (writer, context) =>
                    {
                        ...
                        RecordJsonLeafWriter.WriteFormKey(writer, insertItem.Item, context);
                        writer.WriteEndObject();
                    });
                return new SkyrimPreparedFormListEdit(
    ...
    /// <summary>Prepares one unsigned plugin header value.</summary>
    /// <param name="commandName">The stable command discriminator.</param>
    /// <param name="kind">The exact private mutation discriminator.</param>
    ...
    /// <summary>Prepares one Boolean plugin header value.</summary>
    /// <param name="commandName">The stable command discriminator.</param>
    /// <param name="kind">The exact private mutation discriminator.</param>
    ...
    private static SkyrimPreparedFormListEdit PrepareUnsupported(FormListEdit edit)
    {
        ...
        var fingerprint = RecordEditFingerprintFactory.Create(
            ...
            (writer, context) =>
            {
                ...
                RecordJsonLeafWriter.WriteString(writer, commandName, context);
                writer.WriteEndObject();
            });
        return new SkyrimPreparedFormListEdit(
    ...
    private enum SkyrimPreparedEditKind
    {
        ...
        /// <summary>The command assigns Mutagen version-control state.</summary>
        SetVersionControl,

        /// <summary>The command assigns Mutagen form-version state.</summary>
        SetFormVersion,

        /// <summary>The command assigns Mutagen secondary-version state.</summary>
        SetVersion2,

        /// <summary>The command assigns Mutagen compression state.</summary>
        SetCompressed,

        /// <summary>The command assigns Mutagen deletion state.</summary>
        SetDeleted,
    ...
    private sealed class SkyrimPreparedFormListEdit : PreparedFormListEdit
    {
        ...
        /// <param name="unsignedValue">The copied unsigned plugin header value.</param>
        /// <param name="booleanValue">The copied Boolean plugin header value.</param>
        /// <param name="majorRecordFlags">The copied typed Skyrim major-record flag value.</param>
        internal SkyrimPreparedFormListEdit(
            SkyrimPreparedEditKind kind,
            RecordEditFingerprintResult fingerprint,
        ...
        /// <summary>Gets the copied unsigned plugin header value.</summary>
        internal uint UnsignedValue { get; }

        /// <summary>Gets the copied Boolean plugin header value.</summary>
