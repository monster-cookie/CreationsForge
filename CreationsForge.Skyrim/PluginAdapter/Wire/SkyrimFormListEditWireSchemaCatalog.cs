...
/// <summary>Exposes the immutable closed command and Mutagen-type schemas for Skyrim Special Edition FormList authoring.</summary>
public sealed class SkyrimFormListEditWireSchemaCatalog : IFormListEditWireSchemaCatalog
{
    ...
    private static readonly RecordWireSchemaCatalogIdentity CatalogIdentity = CreateIdentity();

    /// <summary>The immutable materialized catalog nodes.</summary>
    private static readonly IReadOnlyList<RecordWireSchemaNode> CatalogNodes = CreateNodes();

    /// <summary>The immutable ordered catalog key projection.</summary>
    private static readonly IReadOnlyList<RecordWireSchemaNodeKey> CatalogKeys = Array.AsReadOnly(
    ...
    public IReadOnlyList<RecordWireSchemaNodeKey> Nodes => CatalogKeys;
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var detached = new RecordWireSchemaNode(
            new RecordWireSchemaNodeKey(Identity.CatalogId, node.Key.Kind, node.Key.Name),
            node.Schema,
            node.DefaultTemplate);
        cancellationToken.ThrowIfCancellationRequested();
        return EngineResult<RecordWireSchemaNode>.Success(detached);
    }
    ...
    /// <summary>The reusable closed JSON Schema for the readable Mutagen FormLink representation.</summary>
    ...
    {
        return new CatalogDefinition(RecordWireSchemaNodeKind.Command, name, schema, defaultTemplate);
    }

    /// <summary>Creates one concrete Mutagen-type definition from its exact schema and optional constructible default.</summary>
    /// <param name="name">The stable concrete Mutagen type identity.</param>
    /// <param name="schema">The complete closed JSON Schema object.</param>
    /// <param name="defaultTemplate">The optional syntax-valid Mutagen-constructible default.</param>
    /// <returns>The immutable parsed Mutagen-type definition.</returns>
    private static CatalogDefinition Type(
        string name,
        string schema,
        string? defaultTemplate = null)
    {
        return new CatalogDefinition(RecordWireSchemaNodeKind.Type, name, schema, defaultTemplate);
    }
    ...
    private static RecordWireSchemaCatalogIdentity CreateIdentity()
    {
        ...
        return new RecordWireSchemaCatalogIdentity(
    ...
    private static IReadOnlyList<RecordWireSchemaNode> CreateNodes()
    {
        return Array.AsReadOnly(Definitions.Select(definition =>
            new RecordWireSchemaNode(
                new RecordWireSchemaNodeKey(CatalogIdentity.CatalogId, definition.Kind, definition.Name),
                definition.Schema,
    ...
    private static EngineResult<RecordWireSchemaNode> Failure(string message)
    {
        return EngineResult<RecordWireSchemaNode>.Failure(
    ...
    private sealed class CatalogDefinition
    {
        ...
        /// <param name="name">The stable command discriminator or Mutagen type name.</param>
        /// <param name="schema">The exact closed JSON Schema object.</param>
        /// <param name="defaultTemplate">The optional syntax-valid Mutagen-constructible default JSON.</param>
        ...
        /// <summary>Gets whether the definition describes a command or concrete Mutagen type.</summary>
        internal RecordWireSchemaNodeKind Kind { get; }

        /// <summary>Gets the stable command discriminator or Mutagen type name.</summary>
