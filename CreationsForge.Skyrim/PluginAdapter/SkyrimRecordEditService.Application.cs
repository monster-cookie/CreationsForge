...
public sealed partial class SkyrimRecordEditService
{
    ...
    /// <param name="sources">The borrowed immutable plugin source set used to validate new links.</param>
    /// <param name="candidate">The unpublished complete plugin output candidate.</param>
        ...
        PreparedFormListEdit preparedEdit)
    {
        ...
        if (!edit.IsValid)
        {
            return EngineResult<RecordEditMutationResult>.Failure(edit.Error!);
        }
        ...
        try
        {
            ...
            {
                return EngineResult<RecordEditMutationResult>.Failure(targetResult.Error!);
            }
            ...
            if (targetResult.Value is not FormList target)
            {
                return MutationFailure(
                    ...
                    $"Plugin output identity '{targetFormKey}' is not a mutable Skyrim FormList.");
            }
        ...
        catch (Exception exception)
        {
            return MutationFailure(
                EngineErrorCode.ValidationFailed,
                $"Skyrim rejected the FormList edit: {exception.Message}");
        }
    }

    /// <summary>Applies an exact nullable EditorID and reports immediate Mutagen change.</summary>
    /// <param name="target">The mutable Mutagen target.</param>
    ...
    private static EngineResult<RecordEditMutationResult> ApplyEditorId(FormList target, string? editorId)
    {
    ...
    /// <param name="target">The mutable FormList target.</param>
    ...
    private static EngineResult<RecordEditMutationResult> ApplyReplaceItems(
        SkyrimPluginSourceSet sources,
        SkyrimPluginOutputState candidate,
        FormList target,
    ...
    /// <param name="item">The copied record identity, including intentional null.</param>
    /// <returns>The changed result or a typed position or link failure.</returns>
    private static EngineResult<RecordEditMutationResult> ApplyInsertItem(
        SkyrimPluginSourceSet sources,
        SkyrimPluginOutputState candidate,
        FormList target,
        int index,
    ...
    private static EngineResult<RecordEditMutationResult> ApplyRemoveItem(FormList target, int index)
    {
        if (index >= target.Items.Count)
        {
    ...
    private static EngineResult<RecordEditMutationResult> ApplyClearItems(FormList target)
    {
    ...
    private static EngineResult<RecordEditMutationResult> ApplyMoveItem(
        FormList target,
        int sourceIndex,
    ...
    /// <summary>Sets Mutagen version-control state and reports its immediate typed change.</summary>
    /// <param name="target">The mutable FormList target.</param>
    /// <param name="value">The exact unsigned replacement.</param>
    /// <returns>The successful immediate mutation result.</returns>
    private static EngineResult<RecordEditMutationResult> ApplyVersionControl(FormList target, uint value)
    {
    ...
    /// <summary>Sets Mutagen form-version state and reports its immediate typed change.</summary>
    /// <param name="target">The mutable FormList target.</param>
    /// <param name="value">The exact unsigned replacement.</param>
    /// <returns>The successful immediate mutation result.</returns>
    private static EngineResult<RecordEditMutationResult> ApplyFormVersion(FormList target, ushort value)
    {
    ...
    /// <summary>Sets Mutagen secondary-version state and reports its immediate typed change.</summary>
    /// <param name="target">The mutable FormList target.</param>
    /// <param name="value">The exact unsigned replacement.</param>
    /// <returns>The successful immediate mutation result.</returns>
    private static EngineResult<RecordEditMutationResult> ApplyVersion2(FormList target, ushort value)
    {
    ...
    /// <summary>Sets Mutagen compression state and reports its immediate typed change.</summary>
    /// <param name="target">The mutable FormList target.</param>
    /// <param name="value">Whether the record must be compressed.</param>
    /// <returns>The successful immediate mutation result.</returns>
    private static EngineResult<RecordEditMutationResult> ApplyCompressed(FormList target, bool value)
    {
    ...
    /// <summary>Sets Mutagen deletion state and reports its immediate typed change.</summary>
    /// <param name="target">The mutable FormList target.</param>
    /// <param name="value">Whether the record must be deleted.</param>
    /// <returns>The successful immediate mutation result.</returns>
    private static EngineResult<RecordEditMutationResult> ApplyDeleted(FormList target, bool value)
    {
    ...
    /// <returns>Whether the full Mutagen raw flag field changed.</returns>
    private static EngineResult<RecordEditMutationResult> ApplyMajorRecordFlags(
        FormList target,
    ...
    /// <param name="sources">The immutable plugin source set.</param>
    /// <param name="candidate">The complete unpublished plugin output.</param>
    /// <param name="formKey">The linked record identity, including intentional null.</param>
    /// <returns>A successful unchanged validation result or a typed missing/deleted/unsupported failure.</returns>
    private static EngineResult<RecordEditMutationResult> ValidateNewLink(
        SkyrimPluginSourceSet sources,
        ...
        FormKey formKey)
    {
        ...
        {
            return EngineResult<RecordEditMutationResult>.Failure(resolution.Error!);
        }
        ...
        return resolution.Value switch
        {
            ...
            ReferenceResolutionStatus.Unresolved => MutationFailure(
                EngineErrorCode.ValidationFailed,
                $"Skyrim FormList item reference '{formKey}' was not found in staged output or the plugin source winner."),
            ReferenceResolutionStatus.Deleted => MutationFailure(
                EngineErrorCode.ValidationFailed,
                $"Skyrim FormList item reference '{formKey}' resolves to a deleted record."),
            _ => MutationFailure(
                EngineErrorCode.ValidationFailed,
    ...
    /// <param name="sources">The immutable plugin source set.</param>
    /// <param name="candidate">The complete current plugin output.</param>
    ...
    /// <summary>Finds exactly one plugin output record across every materialized record family.</summary>
    /// <param name="mod">The complete current or original plugin output.</param>
    /// <param name="formKey">The exact record identity.</param>
    /// <returns>The singular record or a typed missing or duplicate failure.</returns>
    ...
    /// <summary>Reads an exact nullable FormKey from a record link without losing intentional null state.</summary>
    /// <param name="link">The Mutagen Skyrim major-record link.</param>
    ...
    /// <summary>Creates a successful immediate Mutagen mutation result.</summary>
    ...
    private static EngineResult<RecordEditMutationResult> MutationSuccess(bool changed)
    {
        return EngineResult<RecordEditMutationResult>.Success(new RecordEditMutationResult(changed));
    }

    /// <summary>Creates a typed Mutagen mutation failure.</summary>
    ...
    private static EngineResult<RecordEditMutationResult> MutationFailure(
        ...
        string message)
    {
        return EngineResult<RecordEditMutationResult>.Failure(new EngineError(code, message));
    }
    ...
    /// <returns>The failed mutation result.</returns>
    private static EngineResult<RecordEditMutationResult> InvalidPosition(
        int index,
        int count,
        bool allowEnd)
    {
