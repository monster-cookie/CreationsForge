...
/// <summary>Verifies the documented closed manifest shape without opening native plugins.</summary>
public sealed class ExternalNativeSampleManifestTests
{
    /// <summary>Initializes the stateless manifest contract test owner.</summary>
    public ExternalNativeSampleManifestTests()
    { }
    ...
    public void LoadFromPath_UsesDocumentedClosedCamelCaseSchema()
    {
        ...
        try
        {
            ...
            var loaded = ExternalNativeSampleManifest.LoadFromPath(manifestPath);
            ...
            var error = Assert.Throws<InvalidDataException>(() => ExternalNativeSampleManifest.LoadFromPath(manifestPath));
