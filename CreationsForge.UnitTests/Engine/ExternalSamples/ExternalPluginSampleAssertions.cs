...
/// <summary>Checks independently derived external override intentions against preview and record values.</summary>
internal static class ExternalPluginSampleAssertions
{
        ...
        string phase)
    {
        ...
        RequireRecordValues(editorId, items, intended, phase);
    }

    /// <summary>Checks direct record values against independently derived EditorID and ordered Items values.</summary>
    ...
    /// <exception cref="InvalidDataException">Thrown when the exact intended values are absent.</exception>
    internal static void RequireRecordValues(
        string? editorId,
