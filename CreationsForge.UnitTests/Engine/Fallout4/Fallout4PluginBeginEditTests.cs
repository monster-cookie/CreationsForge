...
/// <summary>Verifies plugin Fallout 4 FormList allocation, override, and existing-output selection.</summary>
public sealed class Fallout4PluginBeginEditTests
{
    /// <summary>New edits allocate output-owned identities that remain unique across every record family.</summary>
    /// <returns>A task that completes after the plugin source and output lifetimes are released.</returns>
    [Fact]
    ...
    [Fact]
    public async Task BeginEdit_ExistingOutput_SelectsExactFormListWithoutChangingPluginState()
    {
        using var fixture = Fallout4PluginOutputTestFixture.Create();
    ...
    /// <param name="service">The plugin output service under test.</param>
    /// <param name="sources">The open plugin source lifetime.</param>
    ...
    /// <summary>Creates and opens one absent output as a complete in-memory plugin state.</summary>
    /// <param name="fixture">The generated output fixture.</param>
    /// <param name="sources">The open plugin sources.</param>
    ...
    /// <summary>Opens one generated existing output as a complete plugin state.</summary>
    /// <param name="sources">The open plugin sources.</param>
    /// <param name="service">The output service under test.</param>
    ...
    /// <summary>Opens the generated Fallout 4 sources through the complete plugin source loader.</summary>
    /// <param name="fixture">The generated output and source fixture.</param>
    /// <returns>The independently owned plugin source lifetime.</returns>
