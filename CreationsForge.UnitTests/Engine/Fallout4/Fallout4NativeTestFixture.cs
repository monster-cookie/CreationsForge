...
/// <summary>
/// Owns a disposable generated Fallout 4 source/load-order fixture with full and small native master styles.
/// </summary>
internal sealed class Fallout4NativeTestFixture : IDisposable
{
    ...
    /// <summary>
    /// Initializes a generated Fallout 4 fixture and records its native identities.
    /// </summary>
    ...
    /// <param name="missingReferenceFormKey">The deliberately unresolved native identity referenced by the fixture.</param>
    private Fallout4NativeTestFixture(
    ...
    /// <summary>Gets the deliberately unresolved native identity referenced by the fixture.</summary>
    ...
    /// </summary>
    /// <returns>A fixture containing full, small, referenced, and overriding native records.</returns>
    public static Fallout4NativeTestFixture Create()
    {
        var rootDirectory = Directory.CreateTempSubdirectory("CreationsForge-Fallout4Native-");
        var dataDirectory = rootDirectory.CreateSubdirectory("Data");
        var stringsDirectory = rootDirectory.CreateSubdirectory("Strings");

        var source = new Fallout4Mod("NativeSmall.esm", Fallout4Release.Fallout4)
        {
            IsSmallMaster = true,
        };
        var full = new Fallout4Mod("NativeFull.esm", Fallout4Release.Fallout4);
        var patch = new Fallout4Mod("NativePatch.esp", Fallout4Release.Fallout4);
        ...
        return new Fallout4NativeTestFixture(
            rootDirectory,
            dataDirectory,
            stringsDirectory,
            orderedPluginPaths,
    ...
    /// </summary>
    /// <returns>The alternate plugin path with the same native identity as the source.</returns>
