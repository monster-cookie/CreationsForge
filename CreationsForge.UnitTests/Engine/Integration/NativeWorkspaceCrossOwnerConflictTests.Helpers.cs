...
/// <content>Provides deterministic native setup, detached-preview, and physical-artifact helpers.</content>
public sealed partial class NativeWorkspaceCrossOwnerConflictTests
{
    ...
    /// <param name="workspace">The native workspace receiving output state.</param>
    ...
    private static OutputAssociation CreateEmbeddedOutputAssociation(NativeWorkspaceIntegrationFixture fixture)
    {
