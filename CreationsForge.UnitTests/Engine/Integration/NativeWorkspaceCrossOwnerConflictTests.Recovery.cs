...
public sealed partial class NativeWorkspaceCrossOwnerConflictTests
{
    ...
    [Theory]
    [InlineData(NativeWorkspaceRecoveryPhysicalState.PreparingAllBefore)]
    [InlineData(NativeWorkspaceRecoveryPhysicalState.PreparedAllPrepared)]
        ...
        NativeWorkspaceRecoveryPhysicalState state)
    {
        ...
        try
        {
            ...
            if (state == NativeWorkspaceRecoveryPhysicalState.PreparingAllBefore)
            {
