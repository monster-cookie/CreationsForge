...
/// <summary>Verifies independent workspace owners cannot overwrite shared output through stale local authority.</summary>
public sealed partial class WorkspaceCrossOwnerConflictTests
{
    ...
    /// <param name="game">The plugin game exercised through separate production service graphs.</param>
