...
/// <summary>Verifies the production three-game workspace composition through guarded native save and reopen boundaries.</summary>
public sealed class NativeWorkspaceSaveIntegrationTests
{
    ...
    /// <param name="game">The native game whose localized output is exercised.</param>
    ...
    public async Task LocalizedOutput_TranslationsOrEmptyTableCommitAndFreshlyReopen(SupportedGame game)
    {
        ...
        if (game == SupportedGame.Skyrim)
        {
            ...
            presentSidecar.Role.ShouldBe(NativeArtifactRole.Strings);
    ...
    /// <param name="localizedOutputMode">How the native writer must represent localized strings.</param>
    ...
    /// <param name="association">The selected output association.</param>
    /// <param name="formKey">The exact output FormList identity.</param>
    /// <returns>The detached complete native FormList view.</returns>
    ...
    /// <summary>Creates the supported two-language native name edit for a localized output.</summary>
    /// <param name="game">The game whose typed edit implementation owns the native name.</param>
    ...
    private static FormListEdit? CreateLocalizedNameEdit(SupportedGame game)
    {
        ...
        return game switch
        {
            ...
            _ => throw new ArgumentOutOfRangeException(nameof(game), game, "The localized integration test requires a supported native game."),
        };
    }

    /// <summary>Asserts the native read view retains all supported localized Name values without inventing Skyrim data.</summary>
    ...
    private static void AssertLocalizedName(JsonElement record, SupportedGame game)
    {
        ...
        {
            throw new ArgumentOutOfRangeException(nameof(game), game, "The localized integration test requires a supported native game.");
        }
