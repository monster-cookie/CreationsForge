...
/// <summary>Provides a uniform owner for the existing generated plugin fixtures used by three-game workspace integration tests.</summary>
internal sealed class WorkspaceIntegrationFixture : IDisposable
{
    ...
    /// <summary>Creates a uniform view over one game-specific plugin fixture.</summary>
    ...
    /// <param name="readEmbeddedOutputMasters">Reads the ordered plugin master list from a committed embedded output.</param>
    private WorkspaceIntegrationFixture(
        IDisposable fixture,
        SupportedGame game,
    ...
    /// <returns>The complete generated plugin source request.</returns>
    ...
    public WorkspaceOpenRequest CreateOpenRequest(Guid workspaceId)
    {
        ...
        {
            throw new ArgumentException("A plugin integration workspace requires a non-empty identity.", nameof(workspaceId));
        }
    ...
    /// <summary>Gets the game-specific reader for the ordered plugin masters in a committed embedded output.</summary>
    public Func<string, IReadOnlyList<ModKey>> ReadEmbeddedOutputMasters { get; }

    /// <summary>Creates the existing generated plugin fixture for the requested game.</summary>
    /// <param name="game">The supported engine game.</param>
    /// <returns>A uniform fixture owner over the requested game's generated plugin sources.</returns>
    /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="game"/> is undefined.</exception>
    public static WorkspaceIntegrationFixture Create(SupportedGame game)
    {
        return game switch
        {
            ...
            _ => throw new ArgumentOutOfRangeException(nameof(game), game, "The integration fixture requires a supported plugin game."),
        };
    }

    /// <summary>Releases the generated plugin fixture and deletes its task-owned temporary files.</summary>
    public void Dispose()
    {
        _fixture.Dispose();
    }

    /// <summary>Creates a uniform Starfield plugin fixture owner.</summary>
    /// <returns>A Starfield integration fixture.</returns>
    private static WorkspaceIntegrationFixture CreateStarfield()
    {
        var fixture = StarfieldPluginTestFixture.Create();
        return new WorkspaceIntegrationFixture(
            fixture,
    ...
    /// <returns>The ordered plugin master list embedded in the output header.</returns>
    ...
    /// <summary>Creates a uniform Fallout 4 plugin fixture owner.</summary>
    /// <returns>A Fallout 4 integration fixture.</returns>
    private static WorkspaceIntegrationFixture CreateFallout4()
    {
    ...
    /// <summary>Creates a uniform Skyrim Special Edition plugin fixture owner.</summary>
    /// <returns>A Skyrim Special Edition integration fixture.</returns>
    private static WorkspaceIntegrationFixture CreateSkyrim()
    {
