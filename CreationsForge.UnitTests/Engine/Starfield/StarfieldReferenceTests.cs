...
/// <summary>
/// Verifies Starfield's bounded reference resolution and deterministic search behavior.
/// </summary>
public sealed class StarfieldReferenceTests
{
    /// <summary>
    ...
    /// <summary>
    /// Opens the generated source fixture and returns its concrete Starfield plugin source lifetime.
    /// </summary>
    ...
    private static async Task<StarfieldPluginSourceSet> OpenAsync(
        ...
        RecordScope scope)
    {
        ...
        throw new InvalidOperationException("The bounded reference search did not terminate within the fixture's expected page count.");
    }
}
