...
public sealed class StarfieldNestedFieldCodecSemanticTests
{
    ...
    /// </summary>
    /// <param name="useAliases">Whether the plugin owner selects alias-index mode.</param>
    /// <param name="usePackageData">Whether the plugin owner selects package-index mode.</param>
    ...
    /// <param name="scenario">The active value or plugin owner mode to change.</param>
    [Theory]
    ...
    /// <summary>
    /// Verifies canonical link identities ignore ModKey casing while ordinary record strings retain exact casing.
    /// </summary>
    [Fact]
    ...
    /// <returns>A plugin component containing the requested value.</returns>
    ...
    /// <returns>A plugin activity component containing the translated value.</returns>
    ...
    /// <summary>Creates a deterministic translated record string.</summary>
    ...
    /// <summary>Creates a concrete condition with the requested complete link-or-index projection and plugin owner mode.</summary>
    ...
    /// <param name="firstUnusedStringParameter">The optional ordinary string stored by the plugin condition data.</param>
    /// <param name="secondUnusedStringParameter">The optional later ordinary string stored by the plugin condition data.</param>
    /// <param name="useAliases">Whether the plugin owner selects alias-index mode.</param>
    /// <param name="usePackageData">Whether the plugin owner selects package-index mode.</param>
    /// <returns>A plugin float condition.</returns>
    ...
    /// <param name="component">The plugin component to write.</param>
    ...
    /// <param name="condition">The plugin condition to write.</param>
    /// <returns>An owned parsed JSON document.</returns>
    ...
    /// <param name="component">The concrete plugin component to traverse.</param>
    /// <returns>The completed fingerprint and any per-call validation diagnostic.</returns>
    private static RecordEditFingerprintResult FingerprintComponent(IAComponentGetter component)
    {
    ...
    /// <param name="condition">The concrete plugin condition to traverse.</param>
    /// <returns>The completed fingerprint and any per-call validation diagnostic.</returns>
    private static RecordEditFingerprintResult FingerprintCondition(IConditionGetter condition)
    {
        var method = GetCodecMethod(
            "WriteCondition",
            typeof(Utf8JsonWriter),
    ...
    /// <param name="valueType">The plugin root getter parameter type.</param>
    /// <param name="value">The plugin root getter value.</param>
    /// <returns>An owned parsed JSON document.</returns>
    ...
    /// <param name="before">The prior plugin component.</param>
    /// <param name="after">The resulting plugin component.</param>
    ...
    /// <param name="before">The prior plugin condition.</param>
    /// <param name="after">The resulting plugin condition.</param>
    ...
    /// <param name="methodName">The exact generated entrypoint name.</param>
    /// <param name="valueType">The plugin root getter parameter type.</param>
    /// <param name="before">The prior plugin root value.</param>
    /// <param name="after">The resulting plugin root value.</param>
    /// <param name="path">The stable plugin root path.</param>
    /// <returns>The ordered semantic changes.</returns>
    ...
    {
        var codecType = typeof(StarfieldFormListInspector).Assembly.GetType(
