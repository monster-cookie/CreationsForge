...
/// </summary>
public sealed class StarfieldFormListNativeInspectorTests
{
    ...
    /// <param name="formList">The native FormList getter to write.</param>
    /// <param name="cancellationToken">A token observed by the native field traversal.</param>
    /// <returns>An owned parsed document containing the complete view.</returns>
    private static JsonDocument Write(
        StarfieldFormListNativeInspector inspector,
    ...
    /// <summary>Creates one deterministic two-language native string for root view and comparison tests.</summary>
    /// <param name="english">The selected English value.</param>
    /// <param name="french">The preserved French translation.</param>
    /// <returns>The mutable native translated string.</returns>
    ...
    /// <returns>A mutable native FormList containing the requested nested state.</returns>
    ...
    /// <returns>Every installed root field name in native field-index order.</returns>
