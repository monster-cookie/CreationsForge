...
/// </summary>
internal sealed class SkyrimPluginOutputTestFixture : IDisposable
{
    ...
    /// <param name="existingOutputModKey">The plugin existing output identity.</param>
    ...
    private SkyrimPluginOutputTestFixture(
        SkyrimPluginTestFixture sources,
    ...
    public SkyrimPluginTestFixture Sources { get; }
    ...
    /// <summary>Gets the existing output record identity.</summary>
    ...
    /// <returns>An owned fixture with a full .esm output and unrelated records.</returns>
    public static SkyrimPluginOutputTestFixture Create(
        LocalizedOutputMode localizedOutputMode = LocalizedOutputMode.SeparateStringFiles)
    {
        var sources = SkyrimPluginTestFixture.Create();
        try
        {
            ...
            return new SkyrimPluginOutputTestFixture(
                sources,
                outputDirectory,
    ...
    /// <param name="fileName">The absent plugin output file name.</param>
    ...
    /// <summary>Creates one independent two-language record translated string.</summary>
    /// <param name="english">The English value.</param>
    /// <param name="french">The French value.</param>
    /// <returns>The complete translated record string.</returns>
