...
/// </summary>
public sealed class SkyrimFormListNativeInspectorTests
{
    /// <summary>
    /// Verifies the response projection covers the installed Mutagen field index and preserves native link order, duplicates, and null identities.
    /// </summary>
    [Fact]
    public void WriteReadView_CoversInstalledFieldIndexAndPreservesNativeValues()
    {
    ...
    public void Compare_ReportsEveryChangedFieldAndPreciseItemPositions()
    {
        ...
        var changes = new SkyrimFormListNativeInspector().Compare(
            before,
            after,
            TestContext.Current.CancellationToken);
        ...
        var removal = new SkyrimFormListNativeInspector().Compare(
            after,
            before,
            TestContext.Current.CancellationToken);
    ...
    public void Compare_HandlesAbsentRecordsAndPropagatesCancellation()
    {
        ...
        var inspector = new SkyrimFormListNativeInspector();
    ...
    /// <param name="editorId">The nullable native EditorID.</param>
    /// <param name="versionControl">The native version-control value.</param>
    /// <param name="formVersion">The native form version.</param>
    /// <param name="version2">The second native version field.</param>
    /// <param name="rawFlags">The complete native major-record flags.</param>
    /// <param name="items">The ordered native FormKeys, including duplicates and null identities.</param>
    /// <returns>A mutable native FormList used only by the current test.</returns>
