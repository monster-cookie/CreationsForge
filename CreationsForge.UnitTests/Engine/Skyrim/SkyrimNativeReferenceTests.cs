...
/// <summary>
/// Verifies Skyrim Special Edition's bounded native reference resolution and deterministic search behavior.
/// </summary>
public sealed class SkyrimNativeReferenceTests
{
    /// <summary>
    ...
    /// <summary>
    /// Opens the generated source fixture and returns its concrete Skyrim native source lifetime.
    /// </summary>
    ...
    /// <returns>The successfully opened Skyrim native source set.</returns>
    private static async Task<SkyrimNativeSourceSet> OpenAsync(
