...
/// <summary>
/// Verifies Skyrim FormList target allocation and exact source and output selection inside unpublished candidates.
/// </summary>
public sealed class SkyrimPluginBeginEditTests
{
    /// <summary>
    /// Verifies plugin allocation advances past every occupied output record family and leaves current and physical state unchanged.
    /// </summary>
    ...
    /// <param name="sources">The materialized plugin source set.</param>
    ...
    private static async Task<SkyrimPluginOutputState> OpenExistingOutputAsync(
    ...
    private static async Task<SkyrimPluginOutputState> OpenNewOutputAsync(
        SkyrimPluginOutputService service,
        SkyrimPluginSourceSet sources,
        SkyrimPluginOutputTestFixture fixture,
        string fileName)
