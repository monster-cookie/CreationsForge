...
/// <summary>
/// Verifies Skyrim's native plugin, FormList enumeration, and contextual FormList read facades.
/// </summary>
public sealed class SkyrimFormListNativeReadingTests
{
    /// <summary>
    /// Verifies plugin and FormList enumeration preserve supplied order, native group order, provenance, winners, and override counts.
    /// </summary>
    ...
    public async Task ReadFormListContext_ReturnsDetachedSelectionAndMissingReferenceWarnings()
    {
        ...
        try
        {
            ...
            source.Warnings.Select(warning => warning.Code)
                .ShouldBe(["missing-native-reference", "missing-native-reference"]);
    ...
    private static async Task<SkyrimNativeSourceSet> OpenAsync(SkyrimNativeTestFixture fixture)
    {
    ...
    /// </summary>
    /// <param name="summary">The native FormList summary.</param>
