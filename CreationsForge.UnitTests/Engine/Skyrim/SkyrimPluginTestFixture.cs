...
/// </summary>
internal sealed class SkyrimPluginTestFixture : IDisposable
{
    ...
    /// <summary>
    /// Initializes a generated Skyrim fixture and records its plugin identities.
    /// </summary>
    ...
    private SkyrimPluginTestFixture(
    ...
    /// <summary>Gets all generated plugin paths in explicit plugin load-order order.</summary>
    ...
    /// </summary>
    /// <returns>A fixture containing full, small, localized, referenced, and overriding records.</returns>
    public static SkyrimPluginTestFixture Create()
    {
        var rootDirectory = Directory.CreateTempSubdirectory("CreationsForge-SkyrimPlugin-");
        var dataDirectory = rootDirectory.CreateSubdirectory("Data");
        var stringsDirectory = rootDirectory.CreateSubdirectory("Strings");

        var source = new SkyrimMod("PluginSmall.esm", SkyrimRelease.SkyrimSE)
        {
            IsSmallMaster = true,
            UsingLocalization = true,
        };
        var full = new SkyrimMod("PluginFull.esm", SkyrimRelease.SkyrimSE);
        var patch = new SkyrimMod("PluginPatch.esp", SkyrimRelease.SkyrimSE);
        ...
        return new SkyrimPluginTestFixture(
            rootDirectory,
            dataDirectory,
            stringsDirectory,
            orderedPluginPaths,
