...
public class GlobalImporterTests
{
    [Fact]
    public void Import_SavesGlobalAndIncrementsCount()
    {
        ...
        importer.Import(global, result, importedAtUTC);

        importer.RecordType.ShouldBe("GLOB");
    ...
    private sealed class TestGlobalRepository : IGlobalRepository
    {
        ...
        public IList<GlobalDTO> Saved { get; } = new List<GlobalDTO>();
