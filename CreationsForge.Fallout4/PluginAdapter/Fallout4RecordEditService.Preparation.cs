...
public sealed partial class Fallout4RecordEditService
{
    ...
    /// <returns>An immutable private Mutagen payload with its full canonical identity and deterministic validation result.</returns>
    ...
    {
        var fingerprint = RecordEditFingerprintFactory.Create(commandName, static (writer, _) =>
        {
    ...
    {
        var fingerprint = RecordEditFingerprintFactory.Create(commandName, (writer, context) =>
        {
            writer.WriteStartObject();
            writer.WritePropertyName("value");
            RecordJsonLeafWriter.WriteString(writer, text, context);
            writer.WriteEndObject();
        });
    ...
    /// <summary>Copies and prepares one unsigned Mutagen scalar.</summary>
    /// <param name="kind">The supported internal command kind.</param>
    /// <param name="commandName">The stable caller-visible command discriminator.</param>
    ...
    private static PreparedFormListEdit PrepareUnsigned(
        ...
        uint value)
    {
        var fingerprint = RecordEditFingerprintFactory.Create(commandName, (writer, _) =>
        {
            writer.WriteStartObject();
    ...
    /// <summary>Copies and prepares one Boolean Mutagen scalar.</summary>
    /// <param name="kind">The supported internal command kind.</param>
    /// <param name="commandName">The stable caller-visible command discriminator.</param>
    /// <param name="fieldName">The canonical payload field name.</param>
    ...
    /// <param name="commandName">The stable caller-visible command discriminator.</param>
    /// <param name="items">The exact ordered Mutagen identities.</param>
        ...
        int secondIndex)
    {
        ...
        var fingerprint = RecordEditFingerprintFactory.Create(commandName, (writer, context) =>
        {
            ...
            {
                RecordJsonLeafWriter.WriteFormKey(writer, item, context);
            }
    ...
    /// <summary>Copies every localized entry and prepares a canonical Mutagen name payload.</summary>
    ...
    private static PreparedFormListEdit PrepareName(Fallout4SetNameEdit edit)
    {
        ...
        var translatedCopy = new TranslatedString(edit.Name.TargetLanguage, copiedTranslations);
        var fingerprint = RecordEditFingerprintFactory.Create(edit.CommandName, (writer, context) =>
        {
            writer.WriteStartObject();
            writer.WritePropertyName("name");
            RecordJsonLeafWriter.WriteTranslatedString(writer, translatedCopy, CancellationToken.None, context);
            writer.WriteEndObject();
        });
        return new Fallout4PreparedFormListEdit(
    ...
    /// <summary>Prepares typed flags and rejects bits outside the installed Fallout 4 Mutagen enum.</summary>
    ...
    private static PreparedFormListEdit PrepareMajorRecordFlags(Fallout4SetMajorRecordFlagsEdit edit)
    {
        ...
        var fingerprint = RecordEditFingerprintFactory.Create(edit.CommandName, (writer, _) =>
        {
            writer.WriteStartObject();
    ...
    {
        var fingerprint = RecordEditFingerprintFactory.Create(edit.CommandName, static (writer, _) =>
        {
            writer.WriteStartObject();
            writer.WriteEndObject();
        });
    ...
    /// <summary>Combines every declared installed Mutagen enum value into the supported flag mask.</summary>
    ...
    private enum PreparedEditKind
    {
        ...
        /// <summary>Sets Mutagen compression state.</summary>
        SetCompressed,

        /// <summary>Sets Mutagen deletion state.</summary>
        SetDeleted,
        ...
        /// <summary>Sets the typed Mutagen major-record flags.</summary>
        SetMajorRecordFlags
    }
    ...
    {
        /// <summary>Initializes a private prepared payload whose mutable record values are represented as immutable scalars and arrays.</summary>
