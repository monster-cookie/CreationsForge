...
/// <summary>Publishes the immutable content-bound Fallout 4 FormList command and Mutagen leaf schemas.</summary>
public sealed class Fallout4FormListEditWireSchemaCatalog : IFormListEditWireSchemaCatalog
{
    ...
    internal const string FormLinkTypeName = "record.form-link";

    /// <summary>The stable inspector-compatible translated-string type key.</summary>
    internal const string TranslatedStringTypeName = "record.translated-string";
    ...
    private const string FormLinkSchema = "{\"type\":\"object\",\"description\":\"One present FormList link. Plugin null links require isNull true and either JSON null or canonical FormKey.Null; non-null links require isNull false and a canonical non-null Mutagen FormKey string. Whole JSON null represents an absent nullable link rather than a Mutagen null link.\",\"properties\":{\"isNull\":{\"type\":\"boolean\"},\"formKey\":{\"type\":[\"string\",\"null\"],\"maxLength\":1048576}},\"required\":[\"isNull\",\"formKey\"],\"additionalProperties\":false}";
    ...
    /// <summary>Every command node followed by every Mutagen type node in ordinal name order.</summary>
    ...
    {
        (RecordWireSchemaNodeKind.Command, Fallout4FormListEditWireCodec.ClearNameCommand, EmptyArgumentsSchema, "{}"),
        (RecordWireSchemaNodeKind.Command, Fallout4FormListEditWireCodec.SetMajorRecordFlagsCommand, SetMajorRecordFlagsSchema, "{\"majorRecordFlags\":0}"),
        (RecordWireSchemaNodeKind.Command, Fallout4FormListEditWireCodec.SetNameCommand, SetNameSchema, (string?)null),
        (RecordWireSchemaNodeKind.Command, Fallout4FormListEditWireCodec.ClearEditorIdCommand, EmptyArgumentsSchema, "{}"),
        (RecordWireSchemaNodeKind.Command, Fallout4FormListEditWireCodec.ClearItemsCommand, EmptyArgumentsSchema, "{}"),
        (RecordWireSchemaNodeKind.Command, Fallout4FormListEditWireCodec.InsertItemCommand, InsertItemSchema, (string?)null),
        (RecordWireSchemaNodeKind.Command, Fallout4FormListEditWireCodec.MoveItemCommand, MoveItemSchema, (string?)null),
        (RecordWireSchemaNodeKind.Command, Fallout4FormListEditWireCodec.RemoveItemCommand, RemoveItemSchema, (string?)null),
        (RecordWireSchemaNodeKind.Command, Fallout4FormListEditWireCodec.ReplaceItemsCommand, ReplaceItemsSchema, "{\"items\":[]}"),
        (RecordWireSchemaNodeKind.Command, Fallout4FormListEditWireCodec.SetCompressedCommand, SetCompressedSchema, "{\"isCompressed\":false}"),
        (RecordWireSchemaNodeKind.Command, Fallout4FormListEditWireCodec.SetDeletedCommand, SetDeletedSchema, "{\"isDeleted\":false}"),
        (RecordWireSchemaNodeKind.Command, Fallout4FormListEditWireCodec.SetEditorIdCommand, SetEditorIdSchema, (string?)null),
        (RecordWireSchemaNodeKind.Command, Fallout4FormListEditWireCodec.SetFormVersionCommand, SetFormVersionSchema, "{\"formVersion\":131}"),
        (RecordWireSchemaNodeKind.Command, Fallout4FormListEditWireCodec.SetVersion2Command, SetVersion2Schema, "{\"version2\":0}"),
        (RecordWireSchemaNodeKind.Command, Fallout4FormListEditWireCodec.SetVersionControlCommand, SetVersionControlSchema, "{\"versionControl\":0}"),
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (!string.Equals(key.CatalogId, CatalogId, StringComparison.Ordinal))
        {
            return EngineResult<RecordWireSchemaNode>.Failure(new EngineError(
                ...
                "The Fallout 4 Mutagen wire schema key belongs to a stale or foreign catalog."));
        }
        ...
        return EngineResult<RecordWireSchemaNode>.Failure(new EngineError(
            EngineErrorCode.InvalidRequest,
            $"The Fallout 4 Mutagen wire schema node '{key.Name}' is not present in this catalog."));
    }
