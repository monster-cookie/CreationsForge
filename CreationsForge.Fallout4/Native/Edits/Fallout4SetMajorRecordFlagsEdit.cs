...
public sealed class Fallout4SetMajorRecordFlagsEdit : FormListEdit
{
    ...
    /// <param name="majorRecordFlags">The typed native flag combination to assign after supported-bit validation.</param>
    ...
    /// <summary>Gets the typed native Fallout 4 major-record flag combination.</summary>
