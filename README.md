...
FormList (FLST) workflows are implemented for Starfield, Fallout 4, and Skyrim Special Edition. Other record families may appear in reference lookup; they are not supported authoring targets. This workflow does not provide general plugin editing, automatic conflict resolution, or asset preview.
