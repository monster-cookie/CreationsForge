...
(
    ...
    FaceParts                                 TEXT    NULL,
    HeadParts                                 TEXT    NULL,
    HeadTexture                               TEXT    NULL,
    SleepingOutfit                            TEXT    NULL,
    TintLayers                                TEXT    NULL,
    Tints                                     TEXT    NULL,
    SpaceOutfit                               TEXT    NULL,
    BodyMorphRegionValues                     TEXT    NULL,
    ObjectTemplates                           TEXT    NULL,
    AIData                                    TEXT    NULL,
    PRIMARY KEY (Game, ModKey_Name, ModKey_Type, ModKey_FileName, FormKey_ModKey_Name, FormKey_ModKey_Type, FormKey_ModKey_FileName, FormKey_ID),
    FOREIGN KEY (Game, ModKey_Name, ModKey_Type, ModKey_FileName) REFERENCES Plugins (Game, ModKey_Name, ModKey_Type, ModKey_FileName) ON DELETE CASCADE,
    FOREIGN KEY (Game, ModKey_Name, ModKey_Type, ModKey_FileName, FormKey_ModKey_Name, FormKey_ModKey_Type, FormKey_ModKey_FileName, FormKey_ID)
...
(
    ...
    CastingSoundLevel                 TEXT    NULL,
    DualCastScale                     TEXT    NULL,
    Unknown1                          TEXT    NULL,
    BaseCost                          TEXT    NULL,
    MagicSkill                        TEXT    NULL,
    CastingLight_ModKey_Name          TEXT    NULL,
    CastingLight_ModKey_Type          INTEGER NULL,
    CastingLight_ModKey_FileName      TEXT    NULL,
    CastingLight_FormKey_ID           INTEGER NULL,
    MenuDisplayObject_ModKey_Name     TEXT    NULL,
    MenuDisplayObject_ModKey_Type     INTEGER NULL,
    MenuDisplayObject_ModKey_FileName TEXT    NULL,
    MenuDisplayObject_FormKey_ID      INTEGER NULL,
    MinimumSkillLevel                 INTEGER NULL,
    SkillUsageMultiplier              TEXT    NULL,
    SpellmakingCastingTime            TEXT    NULL,
    TaperWeight                       TEXT    NULL,
    SecondActorValue                  TEXT    NULL,
    SecondActorValueWeight            TEXT    NULL,
    SpellmakingArea                   INTEGER NULL,
    EnchantShader_ModKey_Name         TEXT    NULL,
    EnchantShader_ModKey_Type         INTEGER NULL,
    EnchantShader_ModKey_FileName     TEXT    NULL,
    EnchantShader_FormKey_ID          INTEGER NULL,
    ...
    Archetype                         TEXT    NULL,
    ArchetypeActorValue               TEXT    NULL,
    ArchetypeAssociation_ModKey_Name  TEXT    NULL,
    ArchetypeAssociation_ModKey_Type  INTEGER NULL,
    ArchetypeAssociation_ModKey_FileName TEXT NULL,
    ArchetypeAssociation_FormKey_ID   INTEGER NULL,
    UnknownFloat1                     REAL    NULL,
    UnknownFloat3                     REAL    NULL,
    UnknownFloat4                     REAL    NULL,
    UnknownInt2                       INTEGER NULL,
    UnknownInt3                       INTEGER NULL,
    Unknown                           TEXT    NULL,
    Unknown2                          TEXT    NULL,
...
(
    ...
    ExtraBindDataVersion    INTEGER NULL,
    ImportedAtUTC           TEXT    NOT NULL,
    PRIMARY KEY (Game, ModKey_Name, ModKey_Type, ModKey_FileName, RecordType, FormKey_ModKey_Name, FormKey_ModKey_Type, FormKey_ModKey_FileName, FormKey_ID, FragmentSlot, Fragment_Index),
    FOREIGN KEY (Game, ModKey_Name, ModKey_Type, ModKey_FileName, RecordType, FormKey_ModKey_Name, FormKey_ModKey_Type, FormKey_ModKey_FileName, FormKey_ID)
        REFERENCES RecordInstances (Game, ModKey_Name, ModKey_Type, ModKey_FileName, RecordType, FormKey_ModKey_Name, FormKey_ModKey_Type, FormKey_ModKey_FileName, FormKey_ID) ON DELETE CASCADE,
    CHECK (FormKey_ID >= 0),
    CHECK (FragmentSlot <> ''),
...
(
    ...
    CrimeValues_Arrest                        INTEGER NULL,
    CrimeValues_AttackOnSight                 INTEGER NULL,
    CrimeValues_Murder                        INTEGER NULL,
    CrimeValues_Assault                       INTEGER NULL,
    CrimeValues_Trespass                      INTEGER NULL,
    CrimeValues_Pickpocket                    INTEGER NULL,
    CrimeValues_Steal                         INTEGER NULL,
    CrimeValues_StealMult                     REAL    NULL,
    CrimeValues_Escape                        INTEGER NULL,
    CrimeValues_Werewolf                      INTEGER NULL,
    CrimeValues_Unknown                       INTEGER NULL,
    CrimeValues_StealMultiplier               REAL    NULL,
    CrimeValues_WerewolfUnused                INTEGER NULL,
    CrimeValues_Piracy                        INTEGER NULL,
    CrimeValues_SmuggleMultiplier             REAL    NULL,
    VendorValues_StartHour                    REAL    NULL,
    VendorValues_EndHour                      REAL    NULL,
    VendorValues_Radius                       INTEGER NULL,
    VendorValues_BuysStolenItems              INTEGER NULL,
    VendorValues_BuysNonStolenItems           INTEGER NULL,
    VendorValues_BuySellEverythingNotInList   INTEGER NULL,
    VendorLocation_MutagenObjectType          TEXT    NULL,
    VendorLocation_Target_MutagenObjectType   TEXT    NULL,
    VendorLocation_Target_Type                TEXT    NULL,
    VendorLocation_Target_Link_ModKey_Name    TEXT    NULL,
    VendorLocation_Target_Link_ModKey_Type    INTEGER NULL,
    VendorLocation_Target_Link_ModKey_FileName TEXT    NULL,
    VendorLocation_Target_Link_FormKey_ID     INTEGER NULL,
    PRIMARY KEY (Game, ModKey_Name, ModKey_Type, ModKey_FileName, FormKey_ModKey_Name, FormKey_ModKey_Type, FormKey_ModKey_FileName, FormKey_ID),
    FOREIGN KEY (Game, ModKey_Name, ModKey_Type, ModKey_FileName) REFERENCES Plugins (Game, ModKey_Name, ModKey_Type, ModKey_FileName) ON DELETE CASCADE,
    FOREIGN KEY (Game, ModKey_Name, ModKey_Type, ModKey_FileName, FormKey_ModKey_Name, FormKey_ModKey_Type, FormKey_ModKey_FileName, FormKey_ID)
        REFERENCES RecordInstances (Game, ModKey_Name, ModKey_Type, ModKey_FileName, FormKey_ModKey_Name, FormKey_ModKey_Type, FormKey_ModKey_FileName, FormKey_ID) ON DELETE CASCADE,
...
(
    ...
    Rank_Index                          INTEGER NOT NULL,
    Number                              INTEGER NULL,
    Title_Male                          TEXT    NULL,
    Title_Female                        TEXT    NULL,
    ImportedAtUTC                       TEXT    NOT NULL,
    PRIMARY KEY (Game, ModKey_Name, ModKey_Type, ModKey_FileName, FormKey_ModKey_Name, FormKey_ModKey_Type, FormKey_ModKey_FileName, FormKey_ID, Rank_Index),
    FOREIGN KEY (Game, ModKey_Name, ModKey_Type, ModKey_FileName, FormKey_ModKey_Name, FormKey_ModKey_Type, FormKey_ModKey_FileName, FormKey_ID)
        REFERENCES Factions (Game, ModKey_Name, ModKey_Type, ModKey_FileName, FormKey_ModKey_Name, FormKey_ModKey_Type, FormKey_ModKey_FileName, FormKey_ID) ON DELETE CASCADE,
