...
public static class SupportedRecordSpecifications
{
    ...
    /// </summary>
    public static RecordSpecification NPC { get; } = new()
    {
        RecordID = "NPC_",
        RecordType = "NPC",
        TableName = "NPCs",
        ...
        ImplementationNote = "Comparison metadata drives top-level scalar parent rows; level, configuration, supplemental parent rows, form-key list rows, actor data children, keyword, sound, and script rows remain strategy-based."
    };
