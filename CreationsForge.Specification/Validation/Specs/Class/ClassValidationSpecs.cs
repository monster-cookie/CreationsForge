...
namespace CreationsForge.Specification.Validation.Specs.Class;
...
public static class ClassValidationSpecs
{
    ...
    {
        return BaseClass(SpecificationGame.Fallout4, sampleName, formKey);
    }

    private static ValidationSpecBuilder SkyrimClass(string sampleName, string formKey)
    {
        return BaseClass(SpecificationGame.Skyrim, sampleName, formKey)
    ...
    {
        return BaseClass(SpecificationGame.Starfield, sampleName, formKey);
    }

    private static ValidationSpecBuilder BaseClass(SpecificationGame game, string sampleName, string formKey)
    {
        return ValidationSpecBuilder
            .ForRecord(game, SupportedRecordSpecifications.Class)
            .Sample(sampleName)
            .FormKey(formKey)
