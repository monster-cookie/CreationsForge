...
namespace CreationsForge.Specification.Validation.Specs.ConstructibleObject;
...
public static class ConstructibleObjectValidationSpecs
{
    ...
    {
        return BaseConstructibleObject(SpecificationGame.Starfield, sampleName, formKey)
    ...
    {
        return BaseConstructibleObject(SpecificationGame.Fallout4, sampleName, formKey)
    ...
    {
        return BaseConstructibleObject(SpecificationGame.Skyrim, sampleName, formKey)
    ...
    private static ValidationSpecBuilder BaseConstructibleObject(SpecificationGame game, string sampleName, string formKey)
    {
        return ValidationSpecBuilder
            .ForRecord(game, SupportedRecordSpecifications.ConstructibleObject)
            .Sample(sampleName)
            .FormKey(formKey)
