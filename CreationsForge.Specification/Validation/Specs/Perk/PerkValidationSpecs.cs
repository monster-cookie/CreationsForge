...
namespace CreationsForge.Specification.Validation.Specs.Perk;
...
public static class PerkValidationSpecs
{
    ...
    {
        return BasePerk(SpecificationGame.Starfield, sampleName, formKey)
    ...
    {
        var spec = BasePerk(SpecificationGame.Fallout4, sampleName, formKey)
    ...
    {
        var spec = BasePerk(SpecificationGame.Skyrim, sampleName, formKey)
            .AddRule(ValidationFieldRule.Field("Category", "Category"))
            .AddRule(ValidationFieldRule.Field("Categroy", "Category"))
            .AddRule(ValidationFieldRule.Field("Restriction", "RestrictionFormKey"))
            .AddRule(ValidationFieldRule.Field("Training", "TrainingFormKey"))
    ...
    private static ValidationSpecBuilder BasePerk(SpecificationGame game, string sampleName, string formKey)
    {
        return ValidationSpecBuilder
            .ForRecord(game, SupportedRecordSpecifications.Perk)
            .Sample(sampleName)
            .FormKey(formKey)
