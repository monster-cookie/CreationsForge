...
namespace CreationsForge.Specification.Validation.Specs.Container;
...
public static class ContainerValidationSpecs
{
    ...
    {
        return BaseContainer(SpecificationGame.Starfield, sampleName, formKey)
    ...
    {
        var spec = BaseContainer(SpecificationGame.Fallout4, sampleName, formKey)
    ...
    {
        return BaseContainer(SpecificationGame.Skyrim, sampleName, formKey)
    ...
    private static ValidationSpecBuilder BaseContainer(SpecificationGame game, string sampleName, string formKey)
    {
        var spec = ValidationSpecBuilder
            .ForRecord(game, SupportedRecordSpecifications.Container)
            .Sample(sampleName)
            .FormKey(formKey)
