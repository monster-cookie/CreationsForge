...
namespace CreationsForge.Specification.Validation.Specs.Terminal;
...
public static class TerminalValidationSpecs
{
    ...
    {
        var spec = BaseTerminal(SpecificationGame.Starfield, sampleName, formKey)
    ...
    {
        var spec = BaseTerminal(SpecificationGame.Fallout4, sampleName, formKey)
            .AddRule(ValidationFieldRule.TranslatedField("Name", "Name", requireAllLanguages: true))
    ...
    private static ValidationSpecBuilder BaseTerminal(SpecificationGame game, string sampleName, string formKey)
    {
        return ValidationSpecBuilder.ForRecord(game, SupportedRecordSpecifications.Terminal)
            .Sample(sampleName)
            .FormKey(formKey)
