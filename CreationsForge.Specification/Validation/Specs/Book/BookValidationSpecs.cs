...
namespace CreationsForge.Specification.Validation.Specs.Book;
...
public static class BookValidationSpecs
{
    ...
    {
        var spec = BaseBook(SpecificationGame.Fallout4, "PerkMagGunsAndBullets07", "092A8C:Fallout4.esm")
    ...
    {
        var spec = BaseBook(SpecificationGame.Starfield, sampleName, formKey)
            .AddRule(ValidationFieldRule.TranslatedField("Name", "Name"))
    ...
    {
        var spec = BaseBook(SpecificationGame.Fallout4, sampleName, formKey)
    ...
    {
        return BaseBook(SpecificationGame.Skyrim, sampleName, formKey)
            .AddRule(ValidationFieldRule.TranslatedField("BookText", "Text", ValidationValueNormalizer.BookText))
            .AddRule(ValidationFieldRule.TranslatedField("Name", "Name"))
    ...
    private static ValidationSpecBuilder BaseBook(SpecificationGame game, string sampleName, string formKey)
    {
        return ValidationSpecBuilder
            .ForRecord(game, SupportedRecordSpecifications.Book)
            .Sample(sampleName)
            .FormKey(formKey)
