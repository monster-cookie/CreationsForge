...
namespace CreationsForge.Specification.Validation.Specs.MagicEffect;
...
public static class MagicEffectValidationSpecs
{
    ...
    {
        return BaseMagicEffect(SpecificationGame.Starfield, sampleName, formKey);
    }

    private static ValidationSpecBuilder Fallout4MagicEffect(string sampleName, string formKey)
    {
        return BaseMagicEffect(SpecificationGame.Fallout4, sampleName, formKey);
    }

    private static ValidationSpecBuilder SkyrimMagicEffect(string sampleName, string formKey)
    {
        return BaseMagicEffect(SpecificationGame.Skyrim, sampleName, formKey)
    ...
    private static ValidationSpecBuilder BaseMagicEffect(SpecificationGame game, string sampleName, string formKey)
    {
        return ValidationSpecBuilder
            .ForRecord(game, SupportedRecordSpecifications.MagicEffect)
            .Sample(sampleName)
            .FormKey(formKey)
