...
namespace CreationsForge.Specification.Validation.Specs.Door;
...
public static class DoorValidationSpecs
{
    ...
    {
        return BaseDoor(SpecificationGame.Starfield, sampleName, formKey)
    ...
    {
        return BaseDoor(SpecificationGame.Fallout4, sampleName, formKey)
            .AddRule(ValidationFieldRule.ScalarList("Flags", "Flags"))
            .AddRule(ValidationFieldRule.ScalarList("MajorFlags", "MajorFlags"))
    ...
    {
        return BaseDoor(SpecificationGame.Skyrim, sampleName, formKey)
            .AddRule(ValidationFieldRule.ScalarList("Flags", "Flags"))
            .AddRule(ValidationFieldRule.ScalarList("MajorFlags", "MajorFlags"))
            .AddRule(ValidationFieldRule.Field("Model.Data", "Models[0].Data", ValidationValueNormalizer.HexPayload))
            .AddRule(ValidationFieldRule.Field("Model.File", "Models[0].File", ValidationValueNormalizer.ModelFile))
    ...
    private static ValidationSpecBuilder BaseDoor(SpecificationGame game, string sampleName, string formKey)
    {
        return ValidationSpecBuilder
            .ForRecord(game, SupportedRecordSpecifications.Door)
            .Sample(sampleName)
            .FormKey(formKey)
