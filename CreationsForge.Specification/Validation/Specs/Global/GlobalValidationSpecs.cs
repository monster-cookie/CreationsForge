...
namespace CreationsForge.Specification.Validation.Specs.Global;

public static class GlobalValidationSpecs
{
    public static ValidationSpec Starfield_UpdateShatteredSpaceMaster()
    {
        return Global(SpecificationGame.Starfield, "_UpdateShatteredSpaceMaster", "20C81D:Starfield.esm");
    }

    public static ValidationSpec Starfield_2B7FBD_Starfield_esm()
    {
        return Global(SpecificationGame.Starfield, "2B7FBD_Starfield.esm", "2B7FBD:Starfield.esm");
    }

    public static ValidationSpec Starfield_2B91E0_Starfield_esm()
    {
        return Global(SpecificationGame.Starfield, "2B91E0_Starfield.esm", "2B91E0:Starfield.esm");
    }

    public static ValidationSpec Fallout4_AO_Companion_Search_JunkThresholdValue()
    {
        return Global(SpecificationGame.Fallout4, "AO_Companion_Search_JunkThresholdValue", "18E889:Fallout4.esm");
    }

    public static ValidationSpec Fallout4_AO_Companion_Search_NextAllowedDaysUntil()
    {
        return Global(SpecificationGame.Fallout4, "AO_Companion_Search_NextAllowedDaysUntil", "176107:Fallout4.esm");
    }

    public static ValidationSpec Fallout4_AO_Dogmeat_Container_Bailout_Dist()
    {
        return Global(SpecificationGame.Fallout4, "AO_Dogmeat_Container_Bailout_Dist", "043F14:Fallout4.esm");
    }
    ...
    {
        var spec = Global(SpecificationGame.Skyrim, "1stPKillCam", "10636A:Skyrim.esm");
    ...
    {
        var spec = Global(SpecificationGame.Skyrim, "CarriageCost", "050765:Skyrim.esm");
        spec.UiComparisonExpectations.Add(ValidationUiComparisonExpectation.DtoField(["Data"], "Data"));
        return spec;
    }
    ...
    {
        var spec = Global(SpecificationGame.Skyrim, "CarriageCostSmall", "107702:Skyrim.esm");
        spec.UiComparisonExpectations.Add(ValidationUiComparisonExpectation.DtoField(["Data"], "Data"));
        return spec;
    }

    private static ValidationSpec Global(SpecificationGame game, string sampleName, string formKey)
    {
        var gameMajorRecordFlags = game switch
        {
            SpecificationGame.Fallout4 => "Fallout4MajorRecordFlags",
            SpecificationGame.Skyrim => "SkyrimMajorRecordFlags",
            _ => "StarfieldMajorRecordFlags"
        };

        return ValidationSpecBuilder
            .ForRecord(game, SupportedRecordSpecifications.Global)
            .Sample(sampleName)
            .FormKey(formKey)
