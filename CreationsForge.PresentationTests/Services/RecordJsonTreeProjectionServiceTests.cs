...
/// <summary>
/// Verifies record JSON projection retains every structural and scalar distinction required by the browser.
/// </summary>
public sealed class RecordJsonTreeProjectionServiceTests
{
    ...
    [Fact]
    public void Project_CompletePluginShape_PreservesExactOrderedHierarchy()
    {
        using var document = JsonDocument.Parse(
            ...
            """);
        var service = new RecordJsonTreeProjectionService();
        ...
        root.Children[0].ValueText.ShouldBe("\"RecordComponent\"");
    ...
    /// <summary>Verifies an unavailable record context projects to no synthetic field.</summary>
    [Fact]
