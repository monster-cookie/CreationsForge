...
/// <summary>Reads complete fixture output binaries directly through native parsers independently of the desktop coordinator.</summary>
internal static class NativeDesktopOutputAssertions
{
    ...
    /// <returns>Detached complete native inspector values keyed by their real FormKeys.</returns>
        ...
        IReadOnlyList<ModKey> expectedMasters)
    {
        ...
        switch (fixture.Game)
        {
            case SupportedGame.Starfield:
            {
                ...
                var inspector = new StarfieldFormListNativeInspector();
            ...
            default:
                throw new ArgumentOutOfRangeException(nameof(fixture), fixture.Game, "A native desktop output requires a supported game.");
        }
    }
    ...
    /// <param name="record">The directly parsed native FormList.</param>
    /// <returns>The complete detached JSON record.</returns>
    private static JsonElement WriteRecord(IFormListNativeInspector inspector, IMajorRecordGetter record)
    {
