...
internal sealed class WorkspaceChangesTestContext : IDisposable, IAsyncDisposable
{
    ...
    private WorkspaceChangesTestContext(
        ...
        WorkspacePresentationOperationArbiter arbiter,
    ...
    internal WorkspaceChangesViewModel ViewModel { get; }
    ...
    internal WorkspacePresentationOperationArbiter Arbiter { get; }

    /// <summary>Gets the synchronous recording dispatcher.</summary>
    internal InlineUiDispatcher Dispatcher { get; }

    /// <summary>Creates a context with no active workspace.</summary>
    /// <returns>The empty-shell test context.</returns>
    internal static WorkspaceChangesTestContext CreateNoWorkspace()
    {
    ...
    internal static WorkspaceChangesTestContext CreateReadOnly()
    {
    ...
    private static WorkspaceChangesTestContext Create(
        RecordingWorkspaceChangesCoordinator coordinator,
        RecordingWorkspaceChangesWorkspace? workspace,
        bool hasDraftChanges,
        IWorkspaceChangesDialogService? dialogService = null,
        IUiDispatcher? uiDispatcher = null)
    {
        ...
        var viewModel = new WorkspaceChangesViewModel(
            coordinator,
            saveCoordinator,
            arbiter,
            editParticipant,
        ...
        return new WorkspaceChangesTestContext(
            viewModel,
            coordinator,
            workspace,
            editParticipant,
