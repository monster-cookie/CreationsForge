...
/// <summary>
/// Records native shell and settings navigation without creating controls.
/// </summary>
internal sealed class FakeNativeApplicationNavigationService : INativeApplicationNavigationService
{
    /// <summary>Gets how many times the native shell was requested.</summary>
    ...
    public NativeApplicationShutdownLease? ShutdownLease { get; set; } = NativeApplicationShutdownLease.CreateForSettings();

    /// <summary>Gets or sets optional awaited shutdown-reservation behavior.</summary>
    public Func<CancellationToken, Task<NativeApplicationShutdownLease?>>? ShutdownAction { get; set; }
    ...
    /// <inheritdoc />
    public Task<NativeApplicationShutdownLease?> ReserveShutdownAsync(CancellationToken cancellationToken = default)
    {
        cancellationToken.ThrowIfCancellationRequested();
