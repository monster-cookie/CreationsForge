...
internal sealed class PluginMcpWorkspaceSession
{
    ...
    private PluginMcpWorkspaceSession(
        McpClient client,
        Guid workspaceId,
    ...
    /// <param name="fixture">The explicit generated plugin fixture.</param>
    /// <param name="cancellationToken">The finite case token.</param>
    /// <returns>The selected independently owned MCP workspace.</returns>
    public static async Task<PluginMcpWorkspaceSession> OpenAsync(
        McpClient client,
        ...
        CancellationToken cancellationToken)
    {
        ...
        return new PluginMcpWorkspaceSession(
            client,
            workspaceId,
    ...
    public async Task<PluginMcpStagedEdit> StageEditorIdAsync(
        FormKey formKey,
        string editorId,
        CancellationToken cancellationToken)
    {
        ...
        return new PluginMcpStagedEdit(
            editId,
            beginOperationId,
            applyOperationId,
            editorId,
    ...
    public PluginMcpSaveRequest CreateSaveRequest()
    {
        ThrowIfClosed();
        return new PluginMcpSaveRequest(WorkspaceId, Guid.NewGuid(), Revision, BaselineHandle);
    }
    ...
    public async Task<PluginMcpSaveOutcome> SaveAsync(
        PluginMcpSaveRequest request,
        CancellationToken cancellationToken)
    {
        ...
        var result = GetResult(await Client.CallToolAsync(
            ...
            cancellationToken: cancellationToken));
        var outcome = PluginMcpSaveOutcome.FromJson(result);
    ...
    /// <summary>Closes this exact MCP registry workspace and waits for plugin resource disposal.</summary>
    /// <param name="cancellationToken">The finite case token.</param>
    ...
    /// <summary>Maps a plugin release to its stable MCP value.</summary>
...
internal sealed class PluginMcpStagedEdit
{
...
internal sealed class PluginMcpSaveRequest
{
...
internal sealed class PluginMcpSaveOutcome
{
    ...
    public static PluginMcpSaveOutcome FromJson(JsonElement value)
    {
        ...
        return new PluginMcpSaveOutcome(
