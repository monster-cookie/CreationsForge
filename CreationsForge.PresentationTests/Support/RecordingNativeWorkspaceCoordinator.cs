...
/// </summary>
internal sealed class RecordingNativeWorkspaceCoordinator : INativeWorkspaceCoordinator
{
    ...
    public void Publish(NativeWorkspaceDescriptor descriptor, IFormListWorkspace workspace)
    {
