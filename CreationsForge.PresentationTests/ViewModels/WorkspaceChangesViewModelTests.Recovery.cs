...
public sealed partial class WorkspaceChangesViewModelTests
{
    ...
    public async Task CompletePreparedSaveAsync_StillUnknown_RequiresFreshInspectionBeforeNewRepair()
    {
        ...
        await context.ViewModel.ReserveLeaveAsync(WorkspaceLeaveReason.CloseWorkspace);
    ...
    public async Task CompletePreparedSaveAsync_ExternalConflict_OffersOpenAbandonmentWithoutRepairRetry()
    {
        ...
        await context.ViewModel.ReserveLeaveAsync(WorkspaceLeaveReason.OpenWorkspace);
    ...
    internal static ResolvedOutputEvidence Evidence(
        ...
        => new(
            ...
            pending.SaveOperationId,
            pending.SaveBaseRevision,
            new CreationsForge.Core.Engine.PluginInputs.PluginSourceInputBaseline(Guid.NewGuid(), []),
            pending.Output,
            resolvedBaseline,
            status);
