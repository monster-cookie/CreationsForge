...
public sealed partial class NativeWorkspaceChangesViewModelTests
{
    ...
    public async Task ReserveLeaveAsync_FirstStagedRequest_PublishesSaveAndDiscardChoices()
    {
        ...
        {
            request.LeaveReason.ShouldBe(NativeWorkspaceLeaveReason.CloseWorkspace);
    ...
    private static OutputArtifactSetBaseline PhysicalBaseline(OutputAssociation output, string fileId)
        => new(
            ...
            [new NativeArtifactAssociation(
                ...
                language: null,
                new NativeArtifactFingerprint(true, 42, new string('A', 64)),
                new NativeFileIdentity("test", "volume", fileId, 1))]);
