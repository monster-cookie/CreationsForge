...
public sealed class NativeWorkspaceTransitionLease : IDisposable
{
    /// <summary>The callback that atomically releases this lease from its arbiter.</summary>
    private readonly Action<NativeWorkspaceTransitionLease> Release;
    ...
    internal NativeWorkspaceTransitionLease(Action<NativeWorkspaceTransitionLease> release)
    {
