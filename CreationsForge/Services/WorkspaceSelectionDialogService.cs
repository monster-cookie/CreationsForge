...
/// <summary>
/// Hosts workspace selection in a modal window owned by the application root window.
/// </summary>
public sealed class WorkspaceSelectionDialogService : IWorkspaceSelectionDialogService
{
    ...
    /// <summary>Initializes the modal workspace selection service.</summary>
    ...
    public WorkspaceSelectionDialogService(IApplicationWindowService windowService)
    {
    ...
    public Task<bool> ShowAsync(WorkspaceSelectionViewModel viewModel)
    {
        ...
        dialog.Content = new WorkspaceSelectionView(viewModel, CloseDialog);
