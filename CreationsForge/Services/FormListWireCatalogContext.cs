...
public sealed class FormListWireCatalogContext
{
    ...
    public FormListWireCatalogContext(
        ...
        IFormListEditWireCodec codec)
    {
        ...
        {
            throw new ArgumentException("The plugin wire schema catalog and codec must identify the same game and release.");
        }
    ...
    /// <summary>Gets the immutable exact command and plugin-type schema catalog.</summary>
