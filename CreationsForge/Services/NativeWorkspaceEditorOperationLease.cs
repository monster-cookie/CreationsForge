...
public sealed class NativeWorkspaceEditorOperationLease : IDisposable
{
    /// <summary>The callback that atomically releases this lease from its arbiter.</summary>
    private readonly Action<NativeWorkspaceEditorOperationLease> Release;
    ...
    internal NativeWorkspaceEditorOperationLease(Action<NativeWorkspaceEditorOperationLease> release)
    {
