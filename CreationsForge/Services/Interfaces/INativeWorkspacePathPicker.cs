...
/// <summary>
/// Acquires explicit local native workspace paths through Avalonia storage pickers without opening game records.
/// </summary>
public interface INativeWorkspacePathPicker
{
    ...
    /// <summary>Prompts for the native data directory.</summary>
    /// <param name="cancellationToken">A token checked before and after the platform picker.</param>
    /// <returns>The selected local path, or <see langword="null"/> when canceled.</returns>
