...
/// <summary>Publishes one atomic browser selection and refreshes the retained native FormList browser after editor mutations.</summary>
public interface INativeFormListEditorHost : INotifyPropertyChanged
{
    ...
    NativeFormListEditorSelection? Selection { get; }

    /// <summary>Refreshes the native browser and optionally reselects one FormList through its existing generation guard.</summary>
