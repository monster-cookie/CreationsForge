...
/// <summary>Presents one owner-bound modal surface for native change review, persistence, and guarded leave choices.</summary>
public interface INativeWorkspaceChangesDialogService
{
    ...
    Task<NativeWorkspaceChangesDialogResult> ShowAsync(
