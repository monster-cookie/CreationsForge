...
/// <summary>
/// Uses the main window's Avalonia storage provider to acquire explicit native workspace paths.
/// </summary>
public sealed class NativeWorkspacePathPicker : INativeWorkspacePathPicker
{
    /// <summary>Plugin file types supported by the native workspace.</summary>
    ...
    public NativeWorkspacePathPicker(MainWindow mainWindow)
    {
