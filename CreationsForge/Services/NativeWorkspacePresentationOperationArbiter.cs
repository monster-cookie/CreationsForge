...
public sealed class NativeWorkspacePresentationOperationArbiter : INativeWorkspacePresentationOperationArbiter
{
    ...
    private NativeWorkspaceEditorOperationLease? ActiveEditorOperation;
    ...
    /// <inheritdoc />
    public NativeWorkspaceEditorOperationLease? TryBeginEditorOperation()
    {
        NativeWorkspaceEditorOperationLease lease;
        lock (StateLock)
        {
            ...
            lease = new NativeWorkspaceEditorOperationLease(ReleaseEditorOperation);
    ...
    /// <inheritdoc />
    public async ValueTask<NativeWorkspaceTransitionRequest> BeginWorkspaceTransitionRequestAsync(
        CancellationToken cancellationToken = default)
    {
        cancellationToken.ThrowIfCancellationRequested();
        NativeWorkspaceEditorOperationLease? editorOperation;
        ...
        try
        {
            ...
            cancellationToken.ThrowIfCancellationRequested();
            return new NativeWorkspaceTransitionRequest(
                editorOperation,
    ...
    /// <inheritdoc />
    public async ValueTask<NativeWorkspaceTransitionLease> ReserveWorkspaceTransitionAsync(
    ...
    private NativeWorkspaceTransitionLease CreateTransferredTransitionLease()
    {
        return new NativeWorkspaceTransitionLease(ReleaseWorkspaceTransition);
    }
    ...
    private void ReleaseEditorOperation(NativeWorkspaceEditorOperationLease lease)
    {
        var released = false;
        lock (StateLock)
        {
    ...
    private void ReleaseWorkspaceTransition(NativeWorkspaceTransitionLease lease)
    {
