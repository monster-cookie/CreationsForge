...
public sealed class NativeWireDraftIssue
{
    ...
    public NativeWireDraftIssue(NativeWireDraftIssueCode code, string path, string message, NativeWireDraftNode? node = null)
    {
    ...
    public NativeWireDraftIssueCode Code { get; }
