...
public sealed class FormListDraftSerializationResult
{
    ...
    public FormListDraftSerializationResult(JsonElement? arguments, IEnumerable<RecordWireDraftIssue> issues)
    {
