...
public class RecordWireObjectDraftNode : RecordWireDraftNode
{
    /// <summary>The immutable ordered properties.</summary>
    private readonly IReadOnlyList<RecordWireObjectDraftProperty> OrderedProperties;

    /// <summary>The immutable direct child projection.</summary>
    private readonly IReadOnlyList<RecordWireDraftNode> DirectChildren;
    ...
    internal RecordWireObjectDraftNode(
        ...
        IEnumerable<RecordWireObjectDraftProperty> properties)
    ...
    public IReadOnlyList<RecordWireObjectDraftProperty> Properties => OrderedProperties;

    /// <inheritdoc />
    public override IReadOnlyList<RecordWireDraftNode> Children => DirectChildren;
    ...
    public RecordWireDraftNode? FindProperty(string name)
    {
