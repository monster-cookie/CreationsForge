...
/// <summary>Identifies the closed typed draft-node set consumed by the record editor controls.</summary>
public enum RecordWireDraftNodeKind
{
    ...
    String,
    /// <summary>A known or unknown record enum integer.</summary>
    Enum,
    /// <summary>A record FormLink.</summary>
    FormLink,
    /// <summary>An owner-mode-sensitive record FormLink-or-index.</summary>
    FormLinkOrIndex,
    ...
    TranslatedString,
    /// <summary>A record asset graph.</summary>
    Asset,
    /// <summary>A record color graph.</summary>
    Color,
...
public enum RecordWireDraftValueState
{
...
/// <summary>Provides the common observable state for one request-local typed record wire draft value.</summary>
public abstract class RecordWireDraftNode : INotifyPropertyChanged
{
    ...
    protected RecordWireDraftNode(
        RecordWireDraftNodeKind kind,
        string path,
        string displayName,
    ...
    public RecordWireDraftNodeKind Kind { get; }
    ...
    public RecordWireDraftValueState ValueState { get; internal set; }
    ...
    public abstract IReadOnlyList<RecordWireDraftNode> Children { get; }
    ...
    internal void InvalidateOptionalReadOnlyProjection()
    {
        ...
        if (ValueState == RecordWireDraftValueState.RequiredUnset)
        {
            return;
        }

        ValueState = RecordWireDraftValueState.RequiredUnset;
    ...
    protected void ObserveChild(RecordWireDraftNode child)
    {
    ...
    protected void StopObservingChild(RecordWireDraftNode child)
    {
        ArgumentNullException.ThrowIfNull(child);
        child.Changed -= ChildChanged;
    }
