...
/// <summary>Presents guarded application navigation and the active workspace identity.</summary>
public sealed class WorkspaceShellViewModel : ViewModelBase, IWorkspaceLeaveGuard, IDisposable, IAsyncDisposable
{
    /// <summary>Owns the application-wide workspace.</summary>
    ...
    private readonly Func<WorkspaceSelectionViewModel> SelectionViewModelFactory;

    /// <summary>Hosts workspace selection in an owner-bound modal dialog.</summary>
    private readonly IWorkspaceSelectionDialogService SelectionDialogService;

    /// <summary>Coordinates reviewed persistence and proves safe leave dispositions.</summary>
    private readonly WorkspaceChangesViewModel ChangesViewModel;

    /// <summary>Navigates between the shell and application settings.</summary>
    private readonly IApplicationNavigationService NavigationService;
    ...
    /// <summary>Initializes the guarded workspace shell.</summary>
    ...
    /// <param name="navigationService">The plugin application navigation boundary.</param>
    /// <exception cref="ArgumentNullException">Thrown when a required dependency is <see langword="null"/>.</exception>
    public WorkspaceShellViewModel(
        IWorkspaceCoordinator workspaceCoordinator,
        Func<WorkspaceSelectionViewModel> selectionViewModelFactory,
        IWorkspaceSelectionDialogService selectionDialogService,
        WorkspaceChangesViewModel changesViewModel,
    ...
    /// <inheritdoc />
    public ValueTask<WorkspaceLeaveReservation?> ReserveLeaveAsync(
        ...
        bool allowConfirmedAbandonment)
    {
        ...
        if (reservation.Disposition == WorkspaceLeaveDisposition.ConfirmedAbandonmentForOpen &&
    ...
    private static string CreateWorkspaceStatusText(WorkspaceDescriptor? workspace)
    {
