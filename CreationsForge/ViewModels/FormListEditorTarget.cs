...
/// <summary>Captures the exact immutable identity and revision used to begin one FormList edit.</summary>
public sealed class FormListEditorTarget
{
    ...
    /// <param name="role">How the record edit is acquired.</param>
