...
/// <summary>Identifies the current user-visible phase of the native workspace change lifecycle.</summary>
public enum NativeWorkspaceChangesOperationState
{
    ...
    /// <summary>The selected native output is being saved.</summary>
    Saving,
