...
internal abstract class FormListEditorPendingOperation
{
    ...
    protected FormListEditorPendingOperation(
        Guid operationId,
        Guid workspaceId,
...
internal sealed class FormListEditorPendingBegin : FormListEditorPendingOperation
{
    ...
    public FormListEditorPendingBegin(Guid workspaceId, BeginEditRequest request, string actionName)
...
internal sealed class FormListEditorPendingApply : FormListEditorPendingOperation
{
    ...
    public FormListEditorPendingApply(
        Guid workspaceId,
        WorkspaceRevision expectedRevision,
        Guid operationId,
        Guid editId,
        RecordWireSchemaCatalogIdentity catalogIdentity,
        string commandName,
