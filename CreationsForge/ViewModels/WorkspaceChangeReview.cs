...
public sealed class WorkspaceChangeReview
{
    ...
    /// <summary>Gets the exact plugin release captured by the accepted state read.</summary>
    ...
    /// <summary>Gets the aggregate number of unresolved references.</summary>
