...
public sealed partial class NativeFormListBrowserViewModel
{
    ...
    private async Task CompareAsync(
        ...
        NativeFormListContextOption before,
        NativeFormListContextOption after,
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            IReadOnlyList<NativeJsonFieldNodeViewModel>? beforeFields = null;
            IReadOnlyList<NativeJsonFieldNodeViewModel>? afterFields = null;
    ...
    /// <summary>Checks the live workspace revision immediately before executing one native comparison.</summary>
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (stateResult.Value.Revision != expectedRevision || stateResult.ResultRevision != expectedRevision)
        {
            return EngineResult<FormListComparison>.Failure(
                CreateRevisionError("The native workspace changed after this browser selection was loaded."),
                workspace.WorkspaceId,
        ...
        {
            return EngineResult<FormListComparison>.Failure(
                CreateRevisionError("The native workspace changed while the FormList comparison was being read."),
                workspace.WorkspaceId,
                baseRevision: expectedRevision,
