...
/// <summary>Describes the editor's current single-flight plugin operation state.</summary>
public enum FormListEditorOperationState
{
    /// <summary>No record editor operation is running or awaiting exact replay.</summary>
    Idle,
