...
/// <summary>Owns the detached identity and advancing expected revision for one active FormList edit session.</summary>
public sealed class FormListEditorSession
{
    ...
    internal FormListEditorSession(
        Guid workspaceId,
        SupportedGame game,
        GameRelease release,
    ...
    /// <summary>Gets the exact plugin release verified when the session began.</summary>
    ...
    /// <summary>Gets the staged FormList identity.</summary>
