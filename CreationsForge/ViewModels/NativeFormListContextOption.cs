...
/// <summary>
/// Presents one exact native FormList context selection and its enumeration provenance.
/// </summary>
public sealed class NativeFormListContextOption
{
    ...
    public NativeFormListContextOption(
    ...
    public string ProvenanceText => IsWinningOverride
        ? "Winning override resolved by the native load order."
