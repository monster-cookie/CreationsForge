...
/// <summary>Defines the presentation fields and hierarchy shared by native record-type groups and selectable record rows.</summary>
public interface INativeRecordTreeNodeViewModel
{
    ...
    /// <summary>Gets the native context column text, or an empty value for a record-type group.</summary>
    ...
    IReadOnlyList<INativeRecordTreeNodeViewModel> TreeChildren { get; }
