...
internal enum NativeWorkspaceRefreshStep
{
...
internal enum NativeWorkspaceRefreshKind
{
...
internal sealed class NativeWorkspaceReviewCapture
{
    ...
    internal NativeWorkspaceReviewCapture(
        Guid workspaceId,
...
internal sealed class NativeWorkspaceSaveEnvelope
{
    ...
    internal NativeWorkspaceSaveEnvelope(
        Guid workspaceId,
        SupportedGame game,
        GameRelease release,
...
internal sealed class NativeWorkspaceSaveBorrowOutcome
{
    ...
    internal NativeWorkspaceSaveBorrowOutcome(
        NativeWorkspaceSaveEnvelope envelope,
        SaveResult result,
    ...
    internal NativeWorkspaceSaveEnvelope Envelope { get; }
...
internal sealed class NativeWorkspaceDiscardEnvelope
{
    ...
    internal NativeWorkspaceDiscardEnvelope(
        Guid workspaceId,
        OutputAssociation output,
        WorkspacePreview preview,
...
internal sealed class NativeWorkspaceDiscardBorrowOutcome
{
    ...
    internal NativeWorkspaceDiscardBorrowOutcome(
        NativeWorkspaceReviewCapture capture,
    ...
    internal NativeWorkspaceReviewCapture Capture { get; }

    /// <summary>Gets the exact request envelope, or <see langword="null"/> when Core was not called.</summary>
    internal NativeWorkspaceDiscardEnvelope? Envelope { get; }
...
internal sealed class NativeWorkspaceRecoveryEnvelope
{
    ...
    internal NativeWorkspaceRecoveryEnvelope(
...
internal sealed class NativeWorkspaceRepairEnvelope
{
    ...
    internal NativeWorkspaceRepairEnvelope(
        RepairSaveRequest request,
        NativeWorkspaceRecoveryEnvelope sourceRecovery)
    {
        Request = request;
    ...
    internal NativeWorkspaceRecoveryEnvelope SourceRecovery { get; }
}

/// <summary>Retains an exact recovery-adoption request until its definitive result is mapped.</summary>
internal sealed class NativeWorkspaceAdoptionEnvelope
{
    ...
    internal NativeWorkspaceAdoptionEnvelope(Guid workspaceId, ResolveOutputRecoveryRequest request)
    {
        WorkspaceId = workspaceId;
        Request = request;
    }
...
internal sealed class NativeWorkspaceAdoptionBorrowOutcome
{
    ...
    internal NativeWorkspaceAdoptionBorrowOutcome(
    ...
    internal NativeWorkspaceAdoptionEnvelope Envelope { get; }
...
internal sealed class NativeWorkspaceRefreshEnvelope
{
    ...
    internal NativeWorkspaceRefreshEnvelope(
        NativeWorkspaceRefreshKind kind,
        Guid workspaceId,
        WorkspaceRevision revision,
        OutputArtifactSetBaseline baseline,
        NativeWorkspaceRefreshStep step,
    ...
    internal NativeWorkspaceRefreshKind Kind { get; }
    ...
    internal NativeWorkspaceRefreshStep Step { get; }
    ...
    internal NativeWorkspaceRefreshEnvelope WithAcceptedState(WorkspaceState state)
    {
        return new NativeWorkspaceRefreshEnvelope(
            Kind,
            WorkspaceId,
            Revision,
            Baseline,
...
internal sealed class NativeWorkspaceAbandonmentEnvelope
{
    ...
    internal NativeWorkspaceAbandonmentEnvelope(Guid workspaceId, OutputAssociation output)
    {
        WorkspaceId = workspaceId;
        Output = output;
    }
