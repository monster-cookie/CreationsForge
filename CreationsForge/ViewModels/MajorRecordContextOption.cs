...
/// <summary>Presents one exact major-record context selection and its enumeration provenance.</summary>
public sealed class MajorRecordContextOption
{
    ...
    public MajorRecordContextOption(
    ...
    /// <summary>Gets whether the selected context carries the deletion flag.</summary>
    ...
    /// <summary>Gets whether this option delegates selection to winning-override resolution.</summary>
    ...
    public string ProvenanceText => IsWinningOverride
        ...
        : $"{ContainingModKey?.FileName} | index {LoadOrderIndex} | {Role} | {SourcePath}{(IsDeleted ? " | deleted" : string.Empty)}";
