...
/// <summary>Owns host-level engine services while each opened workspace retains its own separate record lifetime.</summary>
public sealed class EngineServices : IAsyncDisposable
{
    ...
    /// <summary>Initializes an owned engine service lifetime from the resolved Bootstrap graph.</summary>
