...
public static class McpHostRunner
{
    ...
    /// <param name="arguments">Arguments following the top-level <c>mcp</c> command.</param>
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            System.Console.Error.WriteLine("The CreationsForge MCP command does not accept additional arguments.");
            return 2;
        }
