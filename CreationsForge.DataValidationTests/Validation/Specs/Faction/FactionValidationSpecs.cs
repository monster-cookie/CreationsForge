...
namespace CreationsForge.DataValidationTests.Validation.Specs.Faction;
...
public static class FactionValidationSpecs
{
    ...
    {
        return BaseFaction(SupportedGame.Fallout4, sampleName, formKey)
    ...
    {
        return BaseFaction(SupportedGame.Skyrim, sampleName, formKey)
    ...
    {
        return BaseFaction(SupportedGame.Starfield, sampleName, formKey)
    ...
    private static ValidationSpecBuilder BaseFaction(SupportedGame game, string sampleName, string formKey)
    {
