...
namespace CreationsForge.DataValidationTests.Validation.Specs.MiscItem;
...
public static class MiscItemValidationSpecs
{
    ...
    private static ValidationSpec StarfieldMiscItem(
        ...
        bool withModelFlags)
    {
        var spec = BaseMiscItem(SupportedGame.Starfield, sampleName, formKey)
            .AddRule(ValidationFieldRule.DtoDefaultWhenSpriggitAbsent(
                "DirtinessScale",
                "DirtinessScale",
                "0",
    ...
    private static ValidationSpecBuilder BaseMiscItem(SupportedGame game, string sampleName, string formKey)
    {
