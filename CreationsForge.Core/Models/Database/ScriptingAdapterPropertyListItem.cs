...
[TableName("ScriptingAdapterPropertyListItems")]
[PrimaryKey("Game, ModKey_Name, ModKey_Type, ModKey_FileName, RecordType, FormKey_ModKey_Name, FormKey_ModKey_Type, FormKey_ModKey_FileName, FormKey_ID, ScriptingAdapter_Name, Property_Index, ListItem_Index", AutoIncrement = false)]
public class ScriptingAdapterPropertyListItem
{
    public ScriptingAdapterPropertyListItem()
    { }

    public ScriptingAdapterPropertyListItem(ScriptingAdapterPropertyListItemDTO dto)
    {
