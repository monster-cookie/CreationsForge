...
/// <summary>
/// Database row for one VMAD script property struct member.
/// </summary>
[TableName("ScriptingAdapterPropertyStructMembers")]
[PrimaryKey("Game, ModKey_Name, ModKey_Type, ModKey_FileName, RecordType, FormKey_ModKey_Name, FormKey_ModKey_Type, FormKey_ModKey_FileName, FormKey_ID, ScriptingAdapter_Name, Property_Index, Struct_Index, Member_Index", AutoIncrement = false)]
public class ScriptingAdapterPropertyStructMember
{
    /// <summary>
    /// Initializes a blank row for NPoco materialization.
    /// </summary>
    public ScriptingAdapterPropertyStructMember()
    { }

    /// <summary>
    /// Initializes a row from a VMAD script property struct member DTO.
    /// </summary>
    /// <param name="dto">The DTO to persist.</param>
    public ScriptingAdapterPropertyStructMember(ScriptingAdapterPropertyStructMemberDTO dto)
    {
    ...
    [Column("Member_Index")] public int MemberIndex { get; set; }
