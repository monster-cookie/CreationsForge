...
public interface IKeywordMappingRepository
{
    void Save(KeywordMappingDTO dto);

    IReadOnlyList<KeywordMappingDTO> GetByFormKey(SupportedGame game, string recordType, FormKeyDTO formKey);
