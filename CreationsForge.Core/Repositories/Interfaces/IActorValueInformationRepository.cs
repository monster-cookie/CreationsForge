...
public interface IActorValueInformationRepository : IRecordTreeRepository
{
    void Save(ActorValueInformationDTO dto);

    IReadOnlyList<ActorValueInformationDTO> GetByFormKey(SupportedGame game, FormKeyDTO formKey);
