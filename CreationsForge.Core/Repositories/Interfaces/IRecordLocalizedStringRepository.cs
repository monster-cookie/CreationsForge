...
public interface IRecordLocalizedStringRepository
{
    void Save(LocalizedStringDTO dto);

    IReadOnlyList<LocalizedStringDTO> GetByFormKey(SupportedGame game, string recordType, FormKeyDTO formKey);
