...
public class MagicEffectRepository : TypedRecordRepositoryBase, IMagicEffectRepository
{
    ...
    public IReadOnlyList<MagicEffectDTO> GetByFormKey(CreationsForge.Core.Enums.SupportedGame game, CreationsForge.Core.DTOs.Plugins.FormKeyDTO formKey)
    {
        return FetchByFormKey<MagicEffectRow>(
                ...
                CurrentRecord.Flags,
                CurrentRecord.CastType,
                CurrentRecord.TargetType,
                CurrentRecord.ActorValue2_ModKey_Name AS ActorValue2ModKeyName,
                CurrentRecord.ActorValue2_ModKey_Type AS ActorValue2ModKeyType,
                CurrentRecord.ActorValue2_ModKey_FileName AS ActorValue2ModKeyFileName,
                CurrentRecord.ActorValue2_FormKey_ID AS ActorValue2FormKeyId,
                CurrentRecord.ResistValue_ModKey_Name AS ResistValueModKeyName,
                CurrentRecord.ResistValue_ModKey_Type AS ResistValueModKeyType,
                CurrentRecord.ResistValue_ModKey_FileName AS ResistValueModKeyFileName,
                CurrentRecord.ResistValue_FormKey_ID AS ResistValueFormKeyId,
                CurrentRecord.PerkToApply_ModKey_Name AS PerkToApplyModKeyName,
                CurrentRecord.PerkToApply_ModKey_Type AS PerkToApplyModKeyType,
                CurrentRecord.PerkToApply_ModKey_FileName AS PerkToApplyModKeyFileName,
                CurrentRecord.PerkToApply_FormKey_ID AS PerkToApplyFormKeyId,
                CurrentRecord.EquipAbility_ModKey_Name AS EquipAbilityModKeyName,
                CurrentRecord.EquipAbility_ModKey_Type AS EquipAbilityModKeyType,
                CurrentRecord.EquipAbility_ModKey_FileName AS EquipAbilityModKeyFileName,
                CurrentRecord.EquipAbility_FormKey_ID AS EquipAbilityFormKeyId,
                CurrentRecord.Explosion_ModKey_Name AS ExplosionModKeyName,
                CurrentRecord.Explosion_ModKey_Type AS ExplosionModKeyType,
                CurrentRecord.Explosion_ModKey_FileName AS ExplosionModKeyFileName,
                CurrentRecord.Explosion_FormKey_ID AS ExplosionFormKeyId,
                CurrentRecord.CastingArt_ModKey_Name AS CastingArtModKeyName,
                CurrentRecord.CastingArt_ModKey_Type AS CastingArtModKeyType,
                CurrentRecord.CastingArt_ModKey_FileName AS CastingArtModKeyFileName,
                CurrentRecord.CastingArt_FormKey_ID AS CastingArtFormKeyId,
                CurrentRecord.HitEffectArt_ModKey_Name AS HitEffectArtModKeyName,
                CurrentRecord.HitEffectArt_ModKey_Type AS HitEffectArtModKeyType,
                CurrentRecord.HitEffectArt_ModKey_FileName AS HitEffectArtModKeyFileName,
                CurrentRecord.HitEffectArt_FormKey_ID AS HitEffectArtFormKeyId,
                CurrentRecord.HitShader_ModKey_Name AS HitShaderModKeyName,
                CurrentRecord.HitShader_ModKey_Type AS HitShaderModKeyType,
                CurrentRecord.HitShader_ModKey_FileName AS HitShaderModKeyFileName,
                CurrentRecord.HitShader_FormKey_ID AS HitShaderFormKeyId,
                CurrentRecord.ImageSpaceModifier_ModKey_Name AS ImageSpaceModifierModKeyName,
                CurrentRecord.ImageSpaceModifier_ModKey_Type AS ImageSpaceModifierModKeyType,
                CurrentRecord.ImageSpaceModifier_ModKey_FileName AS ImageSpaceModifierModKeyFileName,
                CurrentRecord.ImageSpaceModifier_FormKey_ID AS ImageSpaceModifierFormKeyId,
                CurrentRecord.ImpactData_ModKey_Name AS ImpactDataModKeyName,
                CurrentRecord.ImpactData_ModKey_Type AS ImpactDataModKeyType,
                CurrentRecord.ImpactData_ModKey_FileName AS ImpactDataModKeyFileName,
                CurrentRecord.ImpactData_FormKey_ID AS ImpactDataFormKeyId,
                CurrentRecord.Projectile_ModKey_Name AS ProjectileModKeyName,
                CurrentRecord.Projectile_ModKey_Type AS ProjectileModKeyType,
                CurrentRecord.Projectile_ModKey_FileName AS ProjectileModKeyFileName,
                CurrentRecord.Projectile_FormKey_ID AS ProjectileFormKeyId,
                CurrentRecord.Archetype,
                CurrentRecord.UnknownFloat3,
                CurrentRecord.UnknownInt2,
                CurrentRecord.Unknown,
                CurrentRecord.Unknown2,
                CurrentRecord.DataTypeState
                """)
