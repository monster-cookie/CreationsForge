...
/// </summary>
public sealed class StagedPluginArtifactMapping
{
    ...
    public StagedPluginArtifactMapping(
        PluginArtifactAssociation stagedArtifact,
        string destinationPath)
    {
        ...
        if (stagedArtifact.Role == PluginArtifactRole.StringsArchive)
        {
    ...
    public PluginArtifactAssociation StagedArtifact { get; }
