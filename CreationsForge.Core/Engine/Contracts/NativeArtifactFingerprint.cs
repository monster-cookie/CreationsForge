...
/// <summary>
/// Captures the existence, length, and content digest of one native file baseline.
/// </summary>
public sealed class NativeArtifactFingerprint : IEquatable<NativeArtifactFingerprint>
{
    /// <summary>Initializes an immutable native artifact fingerprint.</summary>
    ...
    public NativeArtifactFingerprint(bool exists, long length, string? sha256)
    {
    ...
    /// <inheritdoc />
    public bool Equals(NativeArtifactFingerprint? other)
    {
    ...
    {
        return Equals(obj as NativeArtifactFingerprint);
    }
