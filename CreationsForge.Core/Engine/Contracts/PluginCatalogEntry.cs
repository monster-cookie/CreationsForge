...
public sealed class PluginCatalogEntry
{
    ...
    /// <param name="localizedOutputMode">The localization representation read from the plugin header.</param>
    /// <param name="masterStyle">The master style read from the plugin header.</param>
    ...
    /// <summary>Gets the localization representation read from the plugin header.</summary>
    public LocalizedOutputMode LocalizedOutputMode { get; }

    /// <summary>Gets the master style read from the plugin header.</summary>
