...
/// <summary>
/// Confirms that a native output candidate became the workspace's selected output.
/// </summary>
public sealed class OutputSelectionReceipt
{
    ...
    /// <param name="baseline">The complete native output-set baseline established while opening.</param>
    ...
    /// <summary>Gets the complete native output-set baseline.</summary>
