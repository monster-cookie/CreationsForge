...
/// <summary>Sets the FormList secondary-version value through its typed unsigned field.</summary>
public sealed class SetVersion2Edit : FormListEdit
{
    /// <summary>Initializes a plugin secondary-version command.</summary>
