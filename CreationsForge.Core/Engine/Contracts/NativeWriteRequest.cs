...
/// <summary>
/// Requests creation and native reopen of a complete output set in a private staging directory.
/// </summary>
public sealed class NativeWriteRequest
{
    /// <summary>Initializes a native staged-write request.</summary>
