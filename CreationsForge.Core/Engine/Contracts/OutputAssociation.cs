...
/// <summary>Identifies the intended output plugin and its plugin formatting choices.</summary>
public sealed class OutputAssociation
{
    ...
    public OutputAssociation(string pluginPath, ModKey modKey, LocalizedOutputMode localizedOutputMode, OutputMasterStyle masterStyle)
    {
        ...
        {
            throw new ArgumentException("The output plugin path must identify the same plugin as its ModKey.", nameof(modKey));
        }
    ...
    /// <summary>Gets the output plugin identity and extension type.</summary>
    public ModKey ModKey { get; }

    /// <summary>Gets how localized strings are represented.</summary>
    public LocalizedOutputMode LocalizedOutputMode { get; }

    /// <summary>Gets the requested plugin master style.</summary>
