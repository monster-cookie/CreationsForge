...
/// <summary>
/// Identifies the FormList allocated, overridden, or selected inside an unpublished output candidate.
/// </summary>
public sealed class RecordEditIdentity
{
    ...
    public RecordEditIdentity(Guid editId, FormKey formKey, FormKey? originFormKey, FormListEditRole role)
    {
