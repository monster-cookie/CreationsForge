...
/// <summary>
/// Adds cancellation checks to synchronous stream reads and seeks performed by native parsers and owns the wrapped stream.
/// </summary>
internal sealed class CancellationCheckingStream : Stream
{
    ...
    /// <summary>The operation-scoped cancellation token checked at native parsing boundaries.</summary>
    ...
    internal CancellationCheckingStream(Stream innerStream, CancellationToken cancellationToken)
    {
        ...
        {
            throw new ArgumentException("Native parsing requires a readable and seekable stream.", nameof(innerStream));
        }
    ...
    {
        throw new NotSupportedException("The native source stream is read-only.");
    }
