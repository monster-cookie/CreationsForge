...
/// <summary>Returns a complete canonical native-edit identity together with any deterministic payload validation failure.</summary>
public sealed class NativeEditFingerprintResult
{
    /// <summary>Initializes the result of one complete canonical native-edit fingerprint write.</summary>
    ...
    public NativeEditFingerprintResult(OperationFingerprint fingerprint, EngineError? validationError)
    {
