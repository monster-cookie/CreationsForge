...
/// <summary>Streams complete defensively copied record edit payloads into versioned canonical SHA-256 identities.</summary>
public static class RecordEditFingerprintFactory
{
    ...
    public static RecordEditFingerprintResult Create(
        string commandName,
        Action<Utf8JsonWriter, RecordJsonWriteContext> writePayload)
    {
        ArgumentException.ThrowIfNullOrWhiteSpace(commandName);
        ArgumentNullException.ThrowIfNull(writePayload);
        var context = new RecordJsonWriteContext(RecordJsonWriteMode.CanonicalFingerprintV1);
        ...
        return new RecordEditFingerprintResult(
