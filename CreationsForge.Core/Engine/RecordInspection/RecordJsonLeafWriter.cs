...
/// <summary>Writes reusable typed record leaf values without reflection or lossy scalar conversion.</summary>
public static class RecordJsonLeafWriter
{
    /// <summary>Writes a nullable record string using unchanged read-view JSON or lossless canonical malformed-UTF-16 encoding.</summary>
    /// <param name="writer">The caller-owned JSON writer.</param>
    /// <param name="value">The exact record string, or <see langword="null"/>.</param>
        ...
        RecordJsonWriteContext? context)
    {
        ...
        if (context is null || context.Mode != RecordJsonWriteMode.CanonicalFingerprintV1 || IsWellFormedUtf16(value))
        {
    ...
    /// <param name="writer">The caller-owned JSON writer.</param>
    /// <param name="value">The record single-precision value.</param>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="writer"/> is <see langword="null"/>.</exception>
    ...
    /// <param name="writer">The caller-owned JSON writer.</param>
    /// <param name="value">The record double-precision value.</param>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="writer"/> is <see langword="null"/>.</exception>
    ...
    /// <param name="writer">The caller-owned JSON writer.</param>
    /// <param name="value">The record byte sequence, or <see langword="null"/>.</param>
    ...
    /// <summary>Writes a nullable record FormKey in canonical Mutagen identity form.</summary>
    /// <param name="writer">The caller-owned JSON writer.</param>
    /// <param name="value">The record identity, or <see langword="null"/>.</param>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="writer"/> is <see langword="null"/>.</exception>
    ...
    /// <summary>Writes a nullable record FormKey in readable or structural canonical identity form.</summary>
    /// <param name="writer">The caller-owned JSON writer.</param>
    /// <param name="value">The record identity, or <see langword="null"/>.</param>
    /// <param name="context">The optional write context; <see langword="null"/> preserves read-view behavior without allocating a context.</param>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="writer"/> is <see langword="null"/>.</exception>
        ...
        RecordJsonWriteContext? context)
    {
        ...
        if (context?.Mode != RecordJsonWriteMode.CanonicalFingerprintV1)
        {
    ...
    /// <summary>Writes a nullable record form link with explicit null-link state and canonical identity.</summary>
    /// <param name="writer">The caller-owned JSON writer.</param>
    /// <param name="value">The record form link, or <see langword="null"/>.</param>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="writer"/> is <see langword="null"/>.</exception>
    ...
    /// <summary>Writes a nullable record form link in readable or structural canonical identity form.</summary>
    /// <param name="writer">The caller-owned JSON writer.</param>
    /// <param name="value">The record form link, or <see langword="null"/>.</param>
    /// <param name="context">The optional write context; <see langword="null"/> preserves read-view behavior without allocating a context.</param>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="writer"/> is <see langword="null"/>.</exception>
    ...
    /// <summary>Writes a nullable record asset link with its preserved supplied and normalized paths.</summary>
    /// <param name="writer">The caller-owned JSON writer.</param>
    /// <param name="value">The record asset link, or <see langword="null"/>.</param>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="writer"/> is <see langword="null"/>.</exception>
    ...
    /// <summary>Writes a nullable record asset link while preserving every path string under the selected representation.</summary>
    /// <param name="writer">The caller-owned JSON writer.</param>
    /// <param name="value">The record asset link, or <see langword="null"/>.</param>
    /// <param name="context">The optional write context; <see langword="null"/> preserves read-view behavior without allocating a context.</param>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="writer"/> is <see langword="null"/>.</exception>
    ...
    /// <param name="writer">The caller-owned JSON writer.</param>
    /// <param name="value">The record translated string, or <see langword="null"/>.</param>
