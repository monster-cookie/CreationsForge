...
public static class RecordSemanticComparer
{
    /// <summary>Compares root record presence and emits the single canonical insertion or removal descriptor.</summary>
    /// <param name="before">The prior detached record, or <see langword="null"/>.</param>
    /// <param name="after">The resulting detached record, or <see langword="null"/>.</param>
    ...
    /// <param name="before">The prior record value.</param>
    /// <param name="after">The resulting record value.</param>
    ...
    /// <summary>Compares nullable record strings ordinally while preserving null versus empty.</summary>
    /// <param name="before">The prior record string, or <see langword="null"/>.</param>
    /// <param name="after">The resulting record string, or <see langword="null"/>.</param>
    ...
    /// <summary>Compares nullable record FormKeys without string conversion.</summary>
    /// <param name="before">The prior record identity, or <see langword="null"/>.</param>
    /// <param name="after">The resulting record identity, or <see langword="null"/>.</param>
    ...
    /// <summary>Compares nullable record form links by wrapper presence, null-link state, and FormKey.</summary>
    /// <param name="before">The prior record link, or <see langword="null"/>.</param>
    /// <param name="after">The resulting record link, or <see langword="null"/>.</param>
    ...
    /// <summary>Compares nullable record form-link-or-index unions by wrapper presence, exact owner-derived mode, and the active physical value.</summary>
    /// <typeparam name="TMajorGetter">The record major-record getter type accepted by the union link.</typeparam>
    /// <param name="before">The prior record union, or <see langword="null"/>.</param>
    /// <param name="after">The resulting record union, or <see langword="null"/>.</param>
    /// <returns><see langword="true"/> when wrapper presence and every mode projection match and the active link or index is equal. In link mode, an absent nullable FormKey and <see cref="FormKey.Null"/> both represent the same record null value.</returns>
    ...
    /// <summary>Compares nullable record asset links by null state and preserved path values.</summary>
    /// <param name="before">The prior record asset link, or <see langword="null"/>.</param>
    /// <param name="after">The resulting record asset link, or <see langword="null"/>.</param>
    ...
    /// <param name="before">The prior record translated string, or <see langword="null"/>.</param>
    /// <param name="after">The resulting record translated string, or <see langword="null"/>.</param>
    ...
    /// <param name="valuesEqual">Whether the typed record values are exactly equal.</param>
    /// <param name="changes">The caller-owned ordered descriptor collection.</param>
    ...
    /// <param name="value">The record translated string to enumerate.</param>
    /// <param name="cancellationToken">A token observed while copying and sorting entries.</param>
    /// <returns>A temporary ordered snapshot that does not retain record state.</returns>
    /// <exception cref="OperationCanceledException">Thrown when <paramref name="cancellationToken"/> is canceled.</exception>
