...
/// <content>Reads exact scalar and native identity leaves from one bounded traversal.</content>
public sealed partial class NativeWireReadContext
{
    /// <summary>Defines the closed single-precision wire object.</summary>
    private static readonly NativeWireObjectShape SingleShape = new(
        "single-precision value",
        new[] { "text", "bits" },
        new[] { "number" });

    /// <summary>Defines the closed double-precision wire object.</summary>
    private static readonly NativeWireObjectShape DoubleShape = new(
        "double-precision value",
        new[] { "text", "bits" },
        new[] { "number" });

    /// <summary>Defines the closed byte-sequence wire object.</summary>
    private static readonly NativeWireObjectShape BytesShape = new(
        "byte sequence",
        new[] { "length", "base64" });
    ...
    public bool ReadBoolean(NativeWireValue value)
    {
        PrepareLeaf(value);
    ...
    /// <exception cref="OperationCanceledException">Thrown when cancellation is requested.</exception>
    public string ReadString(NativeWireValue value)
    {
    ...
    public sbyte ReadSByte(NativeWireValue value)
    {
    ...
    public byte ReadByte(NativeWireValue value)
    {
    ...
    public short ReadInt16(NativeWireValue value)
    {
        var result = ReadInt32(value);
    ...
    public ushort ReadUInt16(NativeWireValue value)
    {
        var result = ReadUInt32(value);
    ...
    public int ReadInt32(NativeWireValue value)
    {
        PrepareLeaf(value);
        var result = 0;
    ...
    public uint ReadUInt32(NativeWireValue value)
    {
        PrepareLeaf(value);
        uint result = 0;
        if (value.Element.ValueKind != JsonValueKind.Number ||
    ...
    public long ReadInt64(NativeWireValue value)
    {
        PrepareLeaf(value);
        if (value.Element.ValueKind == JsonValueKind.Number &&
    ...
    public ulong ReadUInt64(NativeWireValue value)
    {
        PrepareLeaf(value);
        if (value.Element.ValueKind == JsonValueKind.Number &&
    ...
    public float ReadSingle(NativeWireValue value)
    {
    ...
    public double ReadDouble(NativeWireValue value)
    {
    ...
    public Guid ReadGuid(NativeWireValue value)
    {
        var text = ReadString(value);
    ...
    /// <returns>The exact native plugin identity.</returns>
    public ModKey ReadModKey(NativeWireValue value)
    {
        var text = ReadString(value);
    ...
    /// <returns>The exact native record identity.</returns>
    public FormKey ReadFormKey(NativeWireValue value)
    {
        var text = ReadString(value);
    ...
    public byte[] ReadBytes(NativeWireValue value)
    {
    ...
    /// <exception cref="OperationCanceledException">Thrown when cancellation is requested.</exception>
    private void PrepareLeaf(NativeWireValue value)
    {
        EnsureOwned(value);
    ...
    private string ReadString(NativeWireValue value, int maximumLength, string description)
    {
        PrepareLeaf(value);
        if (value.Element.ValueKind != JsonValueKind.String)
        {
