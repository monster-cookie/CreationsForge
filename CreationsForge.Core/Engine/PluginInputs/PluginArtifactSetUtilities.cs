...
/// <summary>Provides deterministic comparison and identity operations for complete plugin artifact sets.</summary>
internal static class PluginArtifactSetUtilities
{
    ...
    /// <param name="artifacts">The complete ordered plugin artifacts.</param>
