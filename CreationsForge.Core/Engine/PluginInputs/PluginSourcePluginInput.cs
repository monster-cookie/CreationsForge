...
/// <summary>
/// Describes one verified explicit plugin input and the plugin header style required to decode its record identities.
/// </summary>
public sealed class PluginSourcePluginInput
{
    /// <summary>Initializes one verified plugin descriptor.</summary>
    /// <param name="path">The canonical absolute plugin path.</param>
    /// <param name="modKey">The plugin identity derived from the file name.</param>
    ...
    /// <param name="masterStyle">The plugin master style read from the plugin header.</param>
    /// <param name="usesLocalization">Whether the plugin header selects external strings files.</param>
    ...
    public PluginSourcePluginInput(
        string path,
        ModKey modKey,
        int loadOrderIndex,
        PluginRole role,
        ...
        bool usesLocalization)
    {
        ...
        {
            throw new ArgumentException("A plugin input requires a canonical absolute path.", nameof(path));
        }
    ...
    /// <summary>Gets the plugin path and identity pair.</summary>
    ...
    /// <summary>Gets the plugin master style read from the plugin header.</summary>
    public MasterStyle MasterStyle { get; }

    /// <summary>Gets whether the plugin header selects external localized-string files.</summary>
