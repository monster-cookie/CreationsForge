...
/// <summary>Provides indexed access to one bounded record wire array.</summary>
public sealed class RecordWireArray
{
    ...
    public RecordWireValue GetElement(int index)
    {
