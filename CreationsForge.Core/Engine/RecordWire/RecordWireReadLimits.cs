...
/// <summary>Defines the maximum resources one record wire decode may consume before constructing a typed edit.</summary>
public sealed class RecordWireReadLimits
{
    ...
    /// <summary>Initializes a bounded record wire decode policy.</summary>
    ...
    /// <summary>Gets the shared default policy for bounded record edit decoding.</summary>
    public static RecordWireReadLimits Default { get; } = new(
        DefaultMaximumDepth,
        DefaultMaximumNodes,
