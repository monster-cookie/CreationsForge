...
/// <summary>
/// Encodes and validates bounded record-search continuation state without retaining server-side result state.
/// </summary>
internal static class ReferenceCursor
{
    ...
    /// <summary>Encodes the next record scan location and all semantic cursor bindings.</summary>
    ...
    /// <param name="recordIndex">The next record ordinal within that source.</param>
    ...
    /// <summary>Validates a continuation token and extracts its next record scan position.</summary>
