...
/// <summary>
/// Represents one Starfield face dial slider position row.
/// </summary>
public class NPCFaceDialPositionDTO
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets the source dial index.
    /// </summary>
    public int? Index { get; set; }

    /// <summary>
    /// Gets or sets the dial position.
    /// </summary>
