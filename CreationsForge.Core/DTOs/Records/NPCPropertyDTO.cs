...
/// <summary>
/// Represents one actor value property row on an NPC.
/// </summary>
public class NPCPropertyDTO
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets the zero-based property row index.
    /// </summary>
    public int PropertyIndex { get; set; }

    /// <summary>
    /// Gets or sets the actor value reference.
    /// </summary>
    public FormKeyDTO? ActorValue { get; set; }

    /// <summary>
    /// Gets or sets the property value when Spriggit exports one.
    /// </summary>
