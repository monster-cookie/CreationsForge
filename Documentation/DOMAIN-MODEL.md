...
category/recipe-filter rows for current supported comparison families are selected by comparison child-group metadata.
Other `AVIF`, `NPC_`, `MGEF`, `PERK`, `STAT`, `BOOK`, `DOOR`, `CONT`,
