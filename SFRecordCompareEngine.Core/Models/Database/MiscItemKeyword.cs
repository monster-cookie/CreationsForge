...
[TableName("MiscItemKeywords")]
[PrimaryKey("ModKey_Name, ModKey_Type, ModKey_FileName, FormKey_ModKey_Name, FormKey_ModKey_Type, FormKey_ModKey_FileName, FormKey_ID, Keyword_Index", AutoIncrement = false)]
public class MiscItemKeyword
{
    ...
    [Column("Keyword_FormKey")] public string KeywordFormKey { get; set; } = string.Empty;
