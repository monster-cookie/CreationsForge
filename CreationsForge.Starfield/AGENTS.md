# CreationsForge.Starfield rules

This folder contains Starfield-specific Mutagen mapping, DTOs, services, repositories, importers, factories, and record support.

## Boundaries

- Keep Starfield-specific Mutagen APIs and record quirks in this project.
- Do not leak Starfield-only assumptions into CreationsForge.Core.
...
- If Starfield differs from another game's record shape, preserve the difference in the game-specific DTO/schema/service rather than forcing a false shared abstraction.
