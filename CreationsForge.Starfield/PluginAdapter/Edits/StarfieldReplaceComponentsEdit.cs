...
/// <summary>Replaces the complete ordered Mutagen component collection without deduplication.</summary>
public sealed class StarfieldReplaceComponentsEdit : FormListEdit
{
    ...
    /// <param name="components">The concrete Mutagen component payloads copied during preparation.</param>
