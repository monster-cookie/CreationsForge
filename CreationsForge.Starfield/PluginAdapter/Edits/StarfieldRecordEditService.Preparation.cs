...
public sealed partial class StarfieldRecordEditService
{
    ...
    /// <summary>Deeply copies and prepares one complete record translated name.</summary>
    ...
    private static StarfieldPreparedEdit PrepareSetName(StarfieldSetNameEdit command)
    {
        ...
        return CreatePrepared(
            ...
            (writer, context) =>
            {
                ...
                RecordJsonLeafWriter.WriteTranslatedString(writer, name, CancellationToken.None, context);
                writer.WriteEndObject();
            },
    ...
    private static StarfieldPreparedEdit PrepareSetAddToList(StarfieldSetAddToListEdit command)
    {
        ...
        return CreatePrepared(
            ...
            (writer, context) =>
            {
                ...
                RecordJsonLeafWriter.WriteFormKey(writer, formKey, context);
                writer.WriteEndObject();
            },
    ...
    private static StarfieldPreparedEdit PrepareSetConditionalEntries(StarfieldSetConditionalEntriesEdit command)
    {
        ...
        return CreatePrepared(
            ...
            {
                writer.WriteStartObject();
                StarfieldFormListInspector.WriteConditionalEntries(
                    writer,
                    entries,
    ...
    private static StarfieldPreparedEdit PrepareReplaceComponents(StarfieldReplaceComponentsEdit command)
    {
        ...
        return CreatePrepared(
            ...
            {
                writer.WriteStartObject();
                StarfieldFormListInspector.WriteComponents(
                    writer,
                    components,
                    CancellationToken.None,
                    context);
    ...
    /// <param name="component">The defensively copied concrete Mutagen component.</param>
    ...
    /// <param name="items">The exact copied Mutagen item identities.</param>
    ...
    /// <summary>Enumerates every record link reachable from copied nested payloads without retaining a parallel record model.</summary>
    ...
    /// <returns>Every non-null record link in Mutagen traversal order.</returns>
    ...
    /// <summary>Enumerates record identity and declared getter-family pairs reachable from one copied nested payload.</summary>
    /// <param name="populate">The closed typed action that installs copied payloads into a temporary FormList.</param>
    /// <param name="fieldName">The command-relative diagnostic prefix.</param>
    ...
    /// <param name="populate">The closed typed action that installs copied payloads into a temporary FormList.</param>
    /// <returns>Plugin identity and declared getter-family pairs in Mutagen traversal order.</returns>
