...
public sealed partial class StarfieldNativeEditService
{
    ...
    /// <summary>Initializes the stateless Starfield native edit service.</summary>
    public StarfieldNativeEditService()
    {
    ...
    /// <param name="target">The exact native FormList identity selected by the staged edit.</param>
    /// <param name="edit">The immutable payload returned by this Starfield service.</param>
    /// <returns>Whether the native candidate changed, or a typed failure before publication.</returns>
        ...
        PreparedFormListEdit edit)
    {
        ...
        {
            return EngineResult<NativeEditMutationResult>.Failure(new EngineError(
                EngineErrorCode.InvalidRequest,
                "The prepared edit was not created by the Starfield native edit service."));
        }
        ...
        {
            return EngineResult<NativeEditMutationResult>.Failure(targetError);
        }
        ...
        {
            return EngineResult<NativeEditMutationResult>.Failure(referenceError);
        }
    ...
    /// <summary>Creates one scalar prepared payload through a closed typed native assignment.</summary>
    ...
    /// <param name="apply">The typed native field assignment.</param>
    ...
    /// <param name="apply">The closed typed native mutation.</param>
    ...
    {
        var fingerprint = NativeEditFingerprintFactory.Create(commandName, writePayload);
    ...
    private static EngineResult<NativeEditMutationResult> Failure(string message)
    {
        return EngineResult<NativeEditMutationResult>.Failure(new EngineError(
    ...
    private sealed class StarfieldPreparedEdit : PreparedFormListEdit
    {
        ...
        /// <param name="references">Optional newly introduced native references.</param>
    ...
    /// <summary>Describes one copied link together with its native declared getter-family constraint.</summary>
    private readonly struct PreparedReference
    {
        /// <summary>Initializes one deterministic prepared reference.</summary>
        /// <param name="formKey">The non-null linked native identity.</param>
        /// <param name="fieldPath">The command-relative field path used in diagnostics.</param>
        /// <param name="expectedType">The native getter interface declared by the typed link.</param>
        ...
        /// <summary>Gets the linked native identity.</summary>
        internal FormKey FormKey { get; }

        /// <summary>Gets the stable command-relative link location.</summary>
        internal string FieldPath { get; }

        /// <summary>Gets the native getter interface that the resolved target must implement.</summary>
